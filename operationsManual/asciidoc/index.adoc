...
For a detailed description and instructions on how to set up clustering, see <<clustering-introduction, Clustering>>.
...
For more information, see the new chapter on <<composite-databases-introduction, Composite databases>>, which replaces the _Fabric_ chapter from previous versions.
...
See <<neo4j-admin, Neo4j Admin and Neo4j CLI>> for details.
...
See <<backup-restore, Backup and restore>> section for detailed descriptions and instructions.

* Incremental offline import. 
+
The `neo4j-admin import` command can now add more data to existing databases. +
<<neo4j-admin-import, Import>> chapter has been updated.
...
See <<logging, the section on the logging mechanisms in Neo4j>> for more details.
...
Visit <<cypher-shell, Cypher Shell page>> for more details.
...
You can find more information in the <<cypher-shell, Cypher Shell section>>.
...
You can find <<tutorial-immutable-privileges, a tutorial>> on how to administer immutable privileges.
...
+
See <<index-configuration, Index configuration>> for more details.

include::introduction/index.adoc[leveloffset=+1]

include::installation/index.adoc[leveloffset=+1]

include::cloud-deployments/index.adoc[leveloffset=+1]
...
include::manage-databases/index.adoc[leveloffset=+1]

include::clustering/index.adoc[leveloffset=+1]

include::composite-databases/index.adoc[leveloffset=+1]

include::backup-restore/index.adoc[leveloffset=+1]
...
include::clustering-advanced/index.adoc[leveloffset=+1]
