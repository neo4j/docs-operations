...
| +"neo4j"+ | +"neo4j-transaction-6"+ | +"query-172"+ | +""+ | +""+ | +""+ | +"SHOW TRANSACTIONS"+ | +"2022-10-17T13:46:31.542Z"+ | +"Running"+ | +PT0.052S+ | +0+
| +"neo4j"+ | +"neo4j-transaction-4"+ | +"query-171"+ | +""+ | +""+ | +""+ | +"MATCH (n) RETURN n"+ | +"2022-10-17T13:46:31.513Z"+ | +"Running"+ | +PT0.081S+ | +0+
11+d|Rows: 2
|===
...
| +"neo4j-transaction-5"+ | +876+ | +26+ | +0+ | +0+
| +"neo4j-transaction-4"+ | +877+ | +782+ | +0+ | +0+
| +"neo4j-transaction-9"+ | +79+ | +77+ | +0+ | +0+
5+d|Rows: 3
|===
