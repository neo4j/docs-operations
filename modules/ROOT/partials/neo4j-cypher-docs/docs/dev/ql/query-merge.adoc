...
See <<query-merge-using-unique-constraints, Using unique constraints with `MERGE`>> to see how `MERGE` can be used in combination with a unique constraint.
...
| +"Keanu Reeves"+ | +1666014770053+ | +<null>+
3+d|Rows: 1 +
Nodes created: 1 +
Properties set: 2 +
Labels added: 1
...
| +"Charlie Sheen"+ | +true+ | +1666014770915+
| +"Martin Sheen"+ | +true+ | +1666014770915+
| +"Michael Douglas"+ | +true+ | +1666014770915+
| +"Oliver Stone"+ | +true+ | +1666014770915+
| +"Rob Reiner"+ | +true+ | +1666014770915+
3+d|Rows: 5 +
Properties set: 10
|===
