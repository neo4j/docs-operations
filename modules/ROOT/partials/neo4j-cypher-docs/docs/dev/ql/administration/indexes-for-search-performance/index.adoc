...
include::../indexes/create-a-single-property-b-tree-index-for-nodes.adoc[leveloffset=+1]

include::../indexes/create-a-single-property-b-tree-index-for-relationships.adoc[leveloffset=+1]

include::../indexes/create-a-single-property-b-tree-index-only-if-it-does-not-already-exist.adoc[leveloffset=+1]

[role=deprecated]
include::../indexes/create-a-single-property-b-tree-index-with-specified-index-provider.adoc[leveloffset=+1]

[role=deprecated]
include::../indexes/create-a-single-property-b-tree-index-with-specified-index-configuration.adoc[leveloffset=+1]

include::../indexes/create-a-composite-b-tree-index-for-nodes.adoc[leveloffset=+1]

include::../indexes/create-a-composite-b-tree-index-for-relationships.adoc[leveloffset=+1]

[role=deprecated]
include::../indexes/create-a-composite-b-tree-index-with-specified-index-provider-and-configuration.adoc[leveloffset=+1]
...
include::../indexes/create-a-token-lookup-index-specifying-the-index-provider.adoc[leveloffset=+1]

include::../indexes/create-a-node-text-index.adoc[leveloffset=+1]

include::../indexes/create-a-relationship-text-index.adoc[leveloffset=+1]

include::../indexes/create-a-text-index-only-if-it-does-not-already-exist.adoc[leveloffset=+1]

include::../indexes/create-a-text-index-specifying-the-index-provider.adoc[leveloffset=+1]

include::../indexes/failure-to-create-an-already-existing-index.adoc[leveloffset=+1]

include::../indexes/failure-to-create-an-index-with-the-same-name-as-an-already-existing-index.adoc[leveloffset=+1]

include::../indexes/failure-to-create-an-index-when-a-constraint-already-exists.adoc[leveloffset=+1]

include::../indexes/failure-to-create-an-index-with-the-same-name-as-an-already-existing-constraint.adoc[leveloffset=+1]
...
| `type`
| The IndexType of this index (`BTREE`, `FULLTEXT`, `LOOKUP`, or `TEXT`).
| `+`
| `+`
...
include::../indexes/listing-all-indexes.adoc[leveloffset=+2]

//cypher/cypher-docs/target/docs/dev/ql/administration/indexes/listing-indexes-with-filtering.asciidoc
include::../indexes/listing-indexes-with-filtering.adoc[leveloffset=+2]
...
The differences in the usage patterns between composite and single-property indexes described in <<administration-indexes-single-vs-composite-index>> also applies to range indexes.
...
DROP INDEX index_name [IF EXISTS]
----
| Drop an index of any index type. This is the <<administration-indexes-drop-indexes, same command>> as for the existing indexes.
| The command is optionally idempotent, with the default behavior to throw an error if you attempt to drop the same index twice.
With `IF EXISTS`, no error is thrown and nothing happens should the index not exist.
...
SHOW [ALL\|BTREE\|FULLTEXT\|LOOKUP\|POINT\|RANGE\|TEXT] INDEX[ES]
    ...
    [RETURN field[, ...] [ORDER BY field[, ...]] [SKIP n] [LIMIT n]]
----
| Extending the existing <<administration-indexes-list-indexes, list index command>> with filters for the new types.
| When using the `RETURN` clause, the `YIELD` clause is mandatory and must not be omitted.
|===

=== Create index examples

include::../indexes/create-a-single-property-range-index-for-nodes.adoc[leveloffset=+1]

include::../indexes/create-a-single-property-range-index-for-relationships.adoc[leveloffset=+1]

include::../indexes/create-a-range-index-only-if-it-does-not-already-exist.adoc[leveloffset=+1]

include::../indexes/create-a-range-index-specifying-the-index-provider.adoc[leveloffset=+1]

include::../indexes/create-a-composite-range-index-for-nodes.adoc[leveloffset=+1]

include::../indexes/create-a-composite-range-index-for-relationships.adoc[leveloffset=+1]

include::../indexes/create-a-node-point-index.adoc[leveloffset=+1]

include::../indexes/create-a-relationship-point-index.adoc[leveloffset=+1]

include::../indexes/create-a-point-index-only-if-it-does-not-already-exist.adoc[leveloffset=+1]

include::../indexes/create-a-point-index-specifying-the-index-provider.adoc[leveloffset=+1]

include::../indexes/create-a-point-index-specifying-the-index-configuration.adoc[leveloffset=+1]

include::../indexes/create-a-point-index-specifying-both-the-index-provider-and-configuration.adoc[leveloffset=+1]
...
include::../indexes/drop-a-single-property-index.adoc[leveloffset=+1]

include::../indexes/drop-a-composite-index.adoc[leveloffset=+1]
