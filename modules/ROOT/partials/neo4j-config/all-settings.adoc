...
|<<config_dbms.security.auth_minimum_password_length,dbms.security.auth_minimum_password_length>>|label:version-number[Neo4j v5.3]The minimum number of characters required in a password.
