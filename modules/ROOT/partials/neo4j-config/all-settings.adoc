...
|Valid values
a|metrics.prometheus.endpoint, a socket address in the format 'hostname:port', 'hostname' or ':port'. If missing port or hostname it is acquired from dbms.default_listen_address
|Default value
m|+++localhost:2004+++
|===
