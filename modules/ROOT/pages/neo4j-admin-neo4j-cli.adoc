...
| label:enterprise[Enterprise Edition] `unbind`
...
| label:enterprise[Enterprise Edition] `backup`
...
| label:enterprise[Enterprise Edition] `copy`
...
| label:enterprise[Enterprise Edition] `restore`
...
| label:enterprise[Enterprise Edition] `inspect`
| Lists the metadata stored in the header of backup files.

For details, see xref:backup-restore/inspect.adoc[].

| label:enterprise[Enterprise Edition] label:new[Introduced in 2025.01] `aggregate`
|Aggregates a chain of backup artifacts into a single artifact.

For details, see xref:backup-restore/aggregate.adoc[].

| label:infinigraph[Infinigraph] `validate`
