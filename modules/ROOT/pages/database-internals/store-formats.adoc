...
* If you are working with a cluster, the database must be re-seeded after migration.
For more information, see xref:operations/clustering/databases/#cluster-seed[Seed a cluster].
...
----
. If you are working with a cluster, re-seed the database after migration.
For more information, see xref:operations/clustering/databases/#cluster-seed[Seed a cluster].
