...
....
+
xref:monitoring/metrics/reference.adoc#metrics-general-purpose[Checkpoint Metrics] are also available and are detailed in the following files, in the _metrics/_ directory:
