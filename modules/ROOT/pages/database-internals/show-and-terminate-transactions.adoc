...
For more information about `transactionsStarted`, `transactionsCommitted`, and `transactionsRolledBack` see the link:{neo4j-docs-base-uri}/cypher-manual/5/subqueries/subqueries-in-transactions/[Cypher Manual -> CALL subqueries in transactions].
