...
|<<config_db.tx_log.preallocate,db.tx_log.preallocate>>|Specify if Neo4j should try to preallocate logical log file in advance. It optimizes filesystem by ensuring there is room to accommodate newly generated files and avoid file-level fragmentation.
...
|===
|Description
a|Specify if Neo4j should try to preallocate logical log file in advance. It optimizes filesystem by ensuring there is room to accommodate newly generated files and avoid file-level fragmentation.
|Valid values
