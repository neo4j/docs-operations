...
[#_neo4j_browser_and_client_settings]
== Neo4j Browser and client settings

[[config_browser.allow_outgoing_connections]]
=== `browser.allow_outgoing_connections`

.browser.allow_outgoing_connections label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.browser.credential_timeout label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.browser.retain_connection_credentials label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.browser.retain_editor_history label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.db.checkpoint.iops.limit label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.db.format label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.db.lock.acquisition.timeout label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.db.track_query_cpu_time label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.databases.seed_from_uri_providers label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
a|Databases may be created from an existing 'seed' (a database backup or dump) stored at some source URI. Different types of seed source are supported by different implementations of `com.neo4j.dbms.seeding.SeedProvider`. For example, seeds stored at `s3://` and `https://` URIs are supported by the builtin `S3SeedProvider` and `URLConnectionSeedProvider` respectively. This list specifies enabled seed providers. If a seed source (URI scheme) is supported by multiple providers in the list, the first matching provider will be used. If the list is set to empty, the seed from uri functionality is effectively disabled.
|Valid values
...
.dbms.max_databases label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.db.logs.query.early_raw_logging_enabled label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.db.logs.query.enabled label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.db.logs.query.max_parameter_length label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.db.logs.query.obfuscate_literals label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.db.logs.query.parameter_logging_enabled label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.db.logs.query.plan_description_enabled label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.db.logs.query.threshold label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.db.logs.query.transaction.enabled label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.db.logs.query.transaction.threshold label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.db.tx_log.preallocate label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.db.tx_log.rotation.retention_policy label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.db.tx_log.rotation.size label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.db.memory.transaction.max label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.db.memory.transaction.total.max label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.server.db.query_cache_size label:deprecated[Deprecated in 5.7]
[cols="<1s,<4"]
|===
|Description
...
.dbms.memory.transaction.total.max label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
[[config_server.memory.pagecache.direction]]
...
.server.memory.pagecache.flush.buffer.enabled label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.server.memory.pagecache.flush.buffer.size_in_pages label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.server.memory.query_cache.sharing_enabled label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
|Valid values
a|server.memory.query_cache.sharing_enabled, a boolean
|Default value
m|+++false+++
|===
...
.server.memory.query_cache.shared_cache_num_entries label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
|Valid values
a|server.memory.query_cache.shared_cache_num_entries, a integer
|Default value
m|+++1000+++
|===
...
|Valid values
a|server.memory.query_cache.per_db_cache_num_entries, a integer
|Default value
m|+++1000+++
|===
...
.db.transaction.bookmark_ready_timeout label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.db.transaction.concurrent.maximum label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.db.transaction.sampling.percentage label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.db.transaction.timeout label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.db.transaction.tracing.level label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.db.cluster.catchup.pull_interval label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.db.cluster.raft.apply.buffer.max_bytes label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.db.cluster.raft.apply.buffer.max_entries label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.db.cluster.raft.in_queue.batch.max_bytes label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.db.cluster.raft.in_queue.max_bytes label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.db.cluster.raft.leader_transfer.priority_group label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.db.cluster.raft.log.prune_strategy label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.db.cluster.raft.log_shipping.buffer.max_bytes label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.db.cluster.raft.log_shipping.buffer.max_entries label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.cluster.catchup.client_inactivity_timeout label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.cluster.discovery.endpoints label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.cluster.discovery.log_level label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.cluster.minimum_initial_system_primaries_count label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.cluster.network.handshake_timeout label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.cluster.network.max_chunk_size label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.cluster.network.supported_compression_algos label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.cluster.raft.binding_timeout label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.cluster.raft.client.max_channels label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.cluster.raft.election_failure_detection_window label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.cluster.raft.leader_failure_detection_window label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.cluster.raft.leader_transfer.balancing_strategy label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.cluster.raft.log.pruning_frequency label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.cluster.raft.log.reader_pool_size label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.cluster.raft.log.rotation_size label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.cluster.raft.membership.join_max_lag label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.cluster.raft.membership.join_timeout label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.cluster.store_copy.max_retry_time_per_request label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.server.cluster.advertised_address label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.server.cluster.catchup.connect_randomly_to_server_group label:enterprise-edition[Enterprise Edition] label:Dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.server.cluster.catchup.upstream_strategy label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.server.cluster.catchup.user_defined_upstream_strategy label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.server.cluster.listen_address label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.server.cluster.network.native_transport_enabled label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.server.cluster.raft.advertised_address label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.server.cluster.raft.listen_address label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.server.cluster.system_database_mode label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.server.discovery.listen_address label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.initial.server.tags label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.cypher.render_plan_description label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.kubernetes.address label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.kubernetes.ca_crt label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.kubernetes.cluster_domain label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.kubernetes.label_selector label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.kubernetes.namespace label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.kubernetes.service_port_name label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.kubernetes.token label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.auth_cache_max_capacity label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.auth_cache_ttl label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.auth_cache_use_ttl label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.auth_minimum_password_length label:version-number[Neo4j v5.3]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.authentication_providers label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.authorization_providers label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.cluster_status_auth_enabled label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.key.name label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.keystore.password label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.keystore.path label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.ldap.authentication.attribute label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.ldap.authentication.cache_enabled label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.ldap.authentication.mechanism label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.ldap.authentication.search_for_attribute label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.ldap.authentication.user_dn_template label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.ldap.authorization.access_permitted_group label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.ldap.authorization.group_membership_attributes label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.ldap.authorization.group_to_role_mapping label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.ldap.authorization.nested_groups_enabled label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.ldap.authorization.nested_groups_search_filter label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.ldap.authorization.system_password label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.ldap.authorization.system_username label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.ldap.authorization.use_system_account label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.ldap.authorization.user_search_base label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.ldap.authorization.user_search_filter label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.ldap.connection_timeout label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.ldap.host label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.ldap.read_timeout label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.ldap.referral label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.ldap.use_starttls label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.log_successful_authentication label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.oidc.<provider>.audience label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.oidc.<provider>.auth_endpoint label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.oidc.<provider>.auth_flow label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.oidc.<provider>.auth_params label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic] label:deprecated[Deprecated]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.oidc.<provider>.authorization.group_to_role_mapping label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.oidc.<provider>.claims.groups label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.oidc.<provider>.claims.username label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.oidc.<provider>.client_id label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.oidc.<provider>.config label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4a"]
|===
|Description
...
.dbms.security.oidc.<provider>.display_name label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.oidc.<provider>.get_groups_from_user_info label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.oidc.<provider>.get_username_from_user_info label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.oidc.<provider>.issuer label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.oidc.<provider>.jwks_uri label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.oidc.<provider>.params label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.oidc.<provider>.token_endpoint label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.oidc.<provider>.token_params label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.oidc.<provider>.user_info_uri label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.security.oidc.<provider>.well_known_discovery_uri label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.initial.dbms.database_allocator label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.initial.dbms.default_primaries_count label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.initial.dbms.default_secondaries_count label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.initial.server.allowed_databases label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.initial.server.denied_databases label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.initial.server.mode_constraint label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.server.metrics.csv.enabled label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.server.metrics.csv.interval label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.server.metrics.csv.rotation.compression label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.server.metrics.csv.rotation.keep_number label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.server.metrics.csv.rotation.size label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.server.metrics.enabled label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.server.metrics.filter label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.server.metrics.graphite.enabled label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.server.metrics.graphite.interval label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.server.metrics.graphite.server label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.server.metrics.jmx.enabled label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.server.metrics.prefix label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.server.metrics.prometheus.enabled label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.server.metrics.prometheus.endpoint label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
a|The hostname and port to use as Prometheus endpoint.
|Valid values
a|server.metrics.prometheus.endpoint, a socket address in the format `hostname:port`, `hostname`, or `:port`. If missing, port and hostname are acquired from `server.default_listen_address`.
|Default value
m|+++localhost:2004+++
|===
...
.server.discovery.advertised_address label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.server.routing.advertised_address label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.routing.client_side.enforce_for_domains label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.dbms.routing.load_balancing.plugin label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.routing.load_balancing.shuffle_enabled label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.routing.reads_on_primaries_enabled label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.dbms.routing.reads_on_writers_enabled label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.server.directories.cluster_state label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.server.directories.metrics label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.server.backup.enabled label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.server.backup.listen_address label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.server.backup.store_copy_max_retry_time_per_request label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
a|Maximum retry time per request during store copy. Regular store files and indexes are downloaded in separate requests during store copy. This configures the maximum time failed requests are allowed to resend.
...
.server.databases.default_to_read_only label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.server.databases.read_only label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.server.databases.writable label:dynamic[Dynamic]
[cols="<1s,<4"]
|===
|Description
...
.server.dynamic.setting.allowlist label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
...
.server.groups label:enterprise-edition[Enterprise Edition] label:dynamic[Dynamic] label:deprecated[Deprecated]
[cols="<1s,<4"]
|===
|Description
...
.server.max_databases label:enterprise-edition[Enterprise Edition] label:deprecated[Deprecated in 5.6]
[cols="<1s,<4"]
|===
|Description
a|The maximum number of databases.
...
.server.panic.shutdown_on_panic label:enterprise-edition[Enterprise Edition]
[cols="<1s,<4"]
|===
|Description
