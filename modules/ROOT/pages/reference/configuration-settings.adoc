...
|<<config_server.memory.query_cache.shared_cache_num_entries, server.memory.query_cache.shared_cache_num_entries>>|label:enterprise-edition[Enterprise only] label:version-number[Neo4j 5.7] The number of cached queries for all databases.
...
// * <<config_server.memory.query_cache.shared_cache_num_entries, server.memory.query_cache.shared_cache_num_entries>>: label:enterprise-edition[Enterprise only]The number of cached queries for all databases.
