...
This setting is deprecated in favour of <<config_dbms.max_databases,`dbms.max_databases`>> in 5.6.
...
m|+++100+++
|Deprecated
a|The `server.max_databases` configuration setting deprecated in favour of <<config_dbms.max_databases,`dbms.max_databases`>> in a 5.6.
|===
