...
|<<config_db.tx_log.preallocate,db.tx_log.preallocate>>|Specify if Neo4j should try to preallocate logical log file in advance. It optimizes filesystem and avoids fragmentation of the log file.
...
|===
|Description
a|Specify if Neo4j should try to preallocate logical log file in advance. It optimizes filesystem and avoids fragmentation of the log file.
|Valid values
