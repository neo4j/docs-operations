...
Some of the settings are labeled Dynamic, which means that they can be changed at runtime, without restarting the service.
...
See also, <<Transaction logs settings>>.
