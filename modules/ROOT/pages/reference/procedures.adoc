...
This page also lists current xref:reference/procedures.adoc#deprecated-procedures[deprecated procedures] and the xref:reference/procedures.adoc#removed-procedures[procedures removed in Neo4j 5], along with their replacements.
