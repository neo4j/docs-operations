...
| Description
a|
Fetch the current `changeId` for use with xref:reference/procedures.adoc#procedure_cdc_query[`cdc.query()`]
...
| Description
a|
Fetch the earliest available `changeId` for use with xref:reference/procedures.adoc#procedure_cdc_query[`cdc.query()`]
...
For mor details, see link:{neo4j-docs-base-uri}/change-data-capture/{page-version}/introduction[Change Data Capture].
| Signature
m|cdc.query(from = cdc.current() :: STRING NOT NULL, selectors = [] :: LIST OF MAP) :: (id :: STRING NOT NULL, txId :: INTEGER NOT NULL, seq :: INTEGER NOT NULL, metadata :: MAP NOT NULL, event :: MAP NOT NULL)
| Mode
m|READ
