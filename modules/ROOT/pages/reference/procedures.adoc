...
| xref:reference/procedures.adoc#procedure_jwt_security_requestAccess[`jwt.security.requestAccess()`]
| label:yes[]
| label:yes[]
| 
...
[[procedure_jwt_security_requestAccess]]
.jwt.securityAccess() 
[cols="<15s,<85"]
|===
| Description
a|
| Signature
m|jwt.security.requestAccess(application :: STRING?) :: (token :: STRING?)
| Mode
m|DBMS
|===
