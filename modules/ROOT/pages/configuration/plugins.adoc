...
If you are using an earlier version of Neo4j, you can get the matching version of the Fleet management plugin from the link:https://neo4j.com/deployment-center/#tools-tab[Neo4j Deployment Center -> Tools tab -> Enterprise Fleet Management].

Starting with Neo4j 2026.03, Fleet Manager is built-in and enabled by default, so there is no need to install it separately.
The Fleet Management plugin is not supported in versions 2026.03 and later.
...
| Fleet management footnote:[Starting with Neo4j 2026.03, Fleet Manager is built-in and is enabled by default. The Fleet Management plugin is not supported in versions 2026.03 and later.]
| `fleet-management`
|
...
* link:https://neo4j.com/docs/bloom-user-guide/current/[Bloom documentation]
