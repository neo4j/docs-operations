...
# to enable GenAI:
# * dbms.security.procedures.unrestricted=genai.*,ai.* \ #<1>
# * dbms.security.procedures.allowlist=genai.*,ai.*
...
----
+
<1> Starting with Neo4j 2025.11, GenAI procedures, available in Cypher 25, have the new prefix `ai.\*`.
The `genai.*` prefix is for procedures deprecated in Cypher 25.
For details, see link:{neo4j-docs-base-uri}/genai/plugin/current/reference/functions-procedures/[Neo4j GenAI plugin -> Functions and procedures].
