...
Reach out to your Neo4j account representative or request a representative link:https://neo4j.com/contact-us/#sales-inquiry[contact you].
====
...
. Add the following line(s) in _$NEO4J_HOME/conf/neo4j.conf_:
+
[source, properties]
----
# to enable GDS:
