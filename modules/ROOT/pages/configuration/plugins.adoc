...
| Bloom Enterprise footnote:[You can also get basic access to Bloom via Graph Apps in Neo4j Desktop without a license key. See link:{neo4j-docs-base-uri}/bloom-user-guide/current//current/bloom-installation/bloom-deployment-modes/[Bloom deployment modes] for more details.]
| `bloom`
| {check-mark}
...
| `graph-algorithms`
|
| link:{neo4j-docs-base-uri}/graph-data-science/current//current/installation/installation-enterprise-edition/[The Neo4j Graph Data Science Library Manual]

| Graph Data Science
| `graph-data-science`
|
| link:{neo4j-docs-base-uri}/graph-data-science/current//current/installation/#_installation_methods[Graph Data Science]
