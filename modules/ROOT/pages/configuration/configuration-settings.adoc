...
// label:enterprise-edition[Enterprise Edition] label:deprecated[Deprecated in 5.23]
...
// label:enterprise-edition[Enterprise Edition] label:new[Introduced in 5.23]
