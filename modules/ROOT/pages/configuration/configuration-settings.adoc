...
For more information on how to split backup or dump archives, see xref:backup-restore/planning.adoc#splitting-backup-archive[Backup and restore planning].
