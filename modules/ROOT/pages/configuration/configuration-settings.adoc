...
|===
|Description
a|A comma-separated list of endpoints which a server should contact in order to discover other cluster members. Typically you should put all members of your cluster, including the current server, in this list.
|Valid values
...
The following settings configure the amount of transaction logs left after a pruning operation and the size of the transaction log files.
