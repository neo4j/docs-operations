...
For lists of changed, deprecated, or removed configuration settings in the 2025-2026 series, refer to xref:changes-2025-2026.adoc[Changes in Neo4j 2025-2026 series], xref:deprecations.adoc[Deprecations] and xref:breaking-changes.adoc[Breaking changes in Neo4j 2025.01].
...
|===
|Description
a|Obfuscates all sensitive information of errors before writing to the log. Note that only some errors are obfuscatable and that other errors will be missing error message and status description, while maintaining GQLSTATUS code.
|Valid values
a|A boolean.
|Default value
m|+++false+++
...
For details, see the xref:changes-removals.adoc#configuration-settings-changes[Changesand removals in Neo4j 2025-2026 series].
====
