...
|Valid values
a|a `,` separated list with elements of type a socket address in the format of `hostname:port`, `hostname`, or `:port`.
|Default value
m|+++null+++
|===
...
|Valid values
a|a socket address in the format of `hostname:port`, `hostname` or `:port`, which accessible address. If missing, port or hostname, it is acquired from `server.default_advertised_address`.
|Default value
m|+++:7687+++
|===
...
|Valid values
a|a socket address in the format of `hostname:port`, `hostname`, or `:port`. If missing, port and hostname are acquired from `server.default_listen_address`.
|Default value
m|+++localhost:2004+++
|===
...
|Valid values
a|a `,` separated list with elements of 'a string'.
|Default value
m|+++native+++
|===
...
|Valid values
a|a `,` separated list with elements of 'a string'. which Can not be empty
|Default value
m|+++memberOf+++
|===
...
|Valid values
a|a `,` separated list with elements of type string.
|Default value
m|++++++
|===
