...
|Valid values
a|label:changed[Changed in 2026.04] A hostname that has no specified port and is an accessible address.
|Default value
m|+++localhost+++
|===
...
|Valid values
a|label:changed[Changed in 2026.04] A hostname that has no specified port.
|Default value
m|+++localhost+++
|===
