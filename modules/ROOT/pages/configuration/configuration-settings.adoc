...
For details about the default settings of `server.jvm.additional`, see xref:configuration/neo4j-conf.adoc#default-values-server.jvm.additional[The neo4j.conf file -> Default values of `server.jvm.additional`].
