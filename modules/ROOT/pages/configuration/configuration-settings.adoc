...
|===
|Description
a|Allow label inference during cardinality estimation. During cardinality estimation, if the planner can logically deduce that a node has a label that was not explicitly expressed in the query, the planner will use this information during cardinality estimation. +
