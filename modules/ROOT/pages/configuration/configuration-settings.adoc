...
|Valid values
a|a comma-separated list comma-separated a socket address in the format of `hostname:port`, `hostname`, or `:port`.
|Default value
m|+++null+++
|===
...
m|+++LIST+++
|Replaced by
m|dbms.cluster.discovery.resolver_type
|===
...
|Valid values
a|a comma-separated list comma-separated 'a string'.
|Default value
m|++++++
|===
...
|Valid values
a|a comma-separated set comma-separated 'a string'.
|Default value
m|++++++
|===
...
|Valid values
a|a comma-separated list with elements of type 'a string identifying a server tag'.contains no duplicate items
|Default value
m|++++++
|===
...
|Valid values
a|a socket address in the format of `hostname:port`, `hostname`, or `:port`. If missing, it is acquired from `server.default_advertised_address`.
|Default value
m|+++:6000+++
|===
...
|Valid values
a|a comma-separated list with elements of type 'a string identifying a server tag'.
|Default value
m|++++++
|===
...
|Valid values
a|a comma-separated list comma-separated
|Default value
m|++++++
|===
...
|Valid values
a|a socket address in the format of `hostname:port`, `hostname`, or `:port`, which accessible address. If missing, it is acquired from `server.default_advertised_address`.
|Default value
m|+++:7000+++
|===
...
|Valid values
a|a socket address in the format `hostname:port`, `hostname` or `:port`. If missing, it is acquired from `server.default_listen_address`.
|Default value
m|+++:7000+++
|===
...
|Valid values
a|a socket address in the format of `hostname:port`, `hostname` or `:port`. it is acquired from `server.default_listen_address`.
|Default value
m|+++:7687+++
|===
...
a|Advertised address for this connector.
|Valid values
a|a socket address in the format of `hostname:port`, `hostname` or `:port`, which accessible address. it is acquired from `server.default_advertised_address`.
|Default value
m|+++:7474+++
|===
...
|Valid values
a|a comma-separated set with elements of type 'one of [TRANSACTIONAL_ENDPOINTS, UNMANAGED_EXTENSIONS, BROWSER, ENTERPRISE_MANAGEMENT_ENDPOINTS]'.
|Default value
...
|Valid values
a|a socket address in the format of `hostname:port`, `hostname` or `:port`, which has no specified port and accessible address
|Default value
m|+++localhost+++
|===
...
|Valid values
a|a socket address in the format of `hostname:port`, `hostname` or `:port`, which has no specified port
|Default value
m|+++localhost+++
|===
...
|Valid values
a|a comma-separated set comma-separated
|Default value
m|++++++
|===
...
====
|Valid values
a|A valid database name containing only alphabetic characters, numbers, dots and dashes with a length between 3 and 63 characters, starting with an alphabetic character but not with the name `system` is an accessible address.
|Default value
m|+++neo4j+++
|===
...
|Valid values
a|a comma-separated list with elements of type 'a string'.
|Default value
m|+++S3SeedProvider+++
|===
...
label:dynamic[Dynamic] label:changed[Default value changed in 5.2]
...
|Valid values
a|a comma-separated list with elements of type 'A simple globbing pattern that can use `*` and `?`.'.
|Default value
...
|Valid values
a|a comma-separated list with elements of 'a string'.
|Default value
m|+++native+++
|===
...
|Valid values
a|a comma-separated list with elements of 'a string'. which Can not be empty
|Default value
m|+++memberOf+++
|===
...
----
|Valid values
a|a string which must be a semicolon-separated list of key-value pairs or empty
|Default value
m|++++++
|===
...
|Valid values
a|a string which cannot be empty
|Default value
...
|Valid values
a|a comma-separated list with elements of type string.
|Default value
m|++++++
|===
...
|Valid values
a|a comma-separated set with elements of type 'A valid database name containing only alphabetic characters, numbers, dots and dashes with a length between 3 and 63 characters, starting with an alphabetic character but not with the name `system`.
|Default value
m|++++++
|===
...
|Valid values
a|a comma-separated list comma-separated '<classname>=<mount point> string'.
|Default value
m|++++++
|===
