...
|Valid values
a|label:changed[Changed in 2025.12] A comma-separated set where each element is a valid database name pattern containing only alphabetic characters, numbers, dots, question marks, asterisk and dashes with a length between 1 and 63 characters..
|Default value
m|++++++
|===
