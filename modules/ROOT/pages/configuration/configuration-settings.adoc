...
|Valid values
a|'hostname' or ':port' which accessible address. If missing port or hostname it is acquired from server.default_advertised_address
|Default value
m|+++:7000+++
|===
...
|Valid values
a|a string which Can not be empty
|Default value
