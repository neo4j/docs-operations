...
For example,`server.cluster.advertised_address=192.168.33.20:6001` listens for transactions from cluster members on the network interface bound to `192.168.33.20` on port `6001`.
...
There should be a relatively high number (5-7) of `system` primaries, spread across servers.
