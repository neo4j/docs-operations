...
|Valid valuesfootnote:[The `implicit` flow is deprecated starting with Neo4j 2026.06 and will be removed in a future release. See xref:tutorial/tutorial-sso-configuration.adoc#why-to-use-pkce[Why to use PKCE as auth flow?] for more information.].
