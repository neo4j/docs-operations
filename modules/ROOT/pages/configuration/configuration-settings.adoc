...
This means the configuration options are available in Neo4j 5.26 LTS version staring from the 5.26.4 patch release and in Neo4j 2025.x series starting from 2025.03.
====
