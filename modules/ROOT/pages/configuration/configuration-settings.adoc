...
The address/port setting that specifies where the server advertises it listens for requests for transactions in the transaction-shipping catch-up protocol.
