...
Use `SHOW SETTINGS` statement to discover which configuration values can be dynamically updated, or consult xref:reference/dynamic-settings-reference.adoc[Dynamic configuration settings reference].
