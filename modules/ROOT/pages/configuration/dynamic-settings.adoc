...
Use the procedure `dbms.listConfig()` to discover which configuration values can be dynamically updated, or consult xref:reference/dynamic-settings-reference.adoc[Dynamic configuration settings reference].
