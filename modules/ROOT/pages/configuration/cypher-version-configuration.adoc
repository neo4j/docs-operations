...
* For versions 2026.02 and later, Cypher 25 is the default version for all newly created databases, but you can still set the default version to Cypher 5 if you want to maintain compatibility with older queries or applications.
