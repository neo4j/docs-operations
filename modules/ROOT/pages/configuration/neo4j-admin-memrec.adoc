...
You can use the `neo4j-admin server memory-recommendation` command to get an initial recommendation on how to configure the memory parameters of your <<database-management-system, Neo4j DBMS>>.
