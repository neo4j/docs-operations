...
For further information, see link:/docs/java-reference/4.4/jmx-metrics#jmx-metrics[Java Reference -> JMX metrics] and https://docs.oracle.com/javase/1.5.0/docs/guide/management/agent.html[the official documentation on Monitoring and Management Using JMX].
...
For more information, see the link:/docs/java-reference/4.4/extending-neo4j/server-debugging#server-debugging[Java Reference -> Setup for remote debugging].
