...
By default, the operating mode of a Neo4j instance (xref:configuration/configuration-settings.adoc#config_server.cluster.initial_mode_constraint[`server.cluster.initial_mode_constraint`]) is set to `SINGLE`.
