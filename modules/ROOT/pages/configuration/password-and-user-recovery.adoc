...
= Password and user recovery
:description: This section describes how to recover from a lost password, specifically for an admin user, and how to recover an admin user if all the admin users have been unassigned the admin role. 
