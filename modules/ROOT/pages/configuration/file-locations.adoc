...
| Labs footnote:[The `$NEO4J_HOME/labs` directory was introduced in Neo4j 4.1.1. For more information, see https://neo4j.com/labs/apoc/{neo4j-version}/installation/[APOC User Guide -> Installation].]
| Contains APOC Core.
| _<neo4j-home>/labs_
| _<neo4j-home>\labs_
