...
* In versions, 2025.07 to 2026.02, the xref:configuration/plugins.adoc#install-and-configure-plugins[Install and configure plugins].
Starting with Neo4j 2026.03, Fleet manager is built-in and enabled by default.
