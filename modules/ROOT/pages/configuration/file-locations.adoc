[[file-locations]]
= File locations
:description: This section provides an overview of where files are stored in the different Neo4j distributions, and the necessary file permissions for running Neo4j. 

This section describes the following:

* xref:configuration/file-locations.adoc#file-locations-locations[Default file locations]
* xref:configuration/file-locations.adoc#file-locations-file-locations[Customize your file locations]
* xref:configuration/file-locations.adoc#file-locations-permissions[File permissions]
...
| _<neo4j-home>/logs_
| _<neo4j-home>\logs_
| _/var/log/neo4j/_ footnote:[To view the _neo4j.log_ for Debian and RPM, use `journalctl --unit=neo4j`.]
