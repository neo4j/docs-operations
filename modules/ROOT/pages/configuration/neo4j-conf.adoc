...
* By default, the character encoding is assumed to be ISO 8859-1. This can be overridden by setting the environment variable `NEO4J_CONFIG_FILE_CHARSET` to e.g. `utf8`.
