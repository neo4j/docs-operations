...
|`server.jvm.additional=-XX:-RestrictContended` footnote:[This option is currently listed in the Enterprise Edition, but it can also be added to the Community Edition.]
