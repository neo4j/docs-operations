...
|label:new[Introduced in Neo4j 5.8] `server.jvm.additional=-XX:-RestrictContended` footnote:[This option is listed in the Enterprise Edition, but it also could be added to the Community Edition.]
...
.3+|Opens modules for Neo4j to allow internal access.

|`server.jvm.additional=--add-opens=java.base/java.io=ALL-UNNAMED`

|`server.jvm.additional=--add-opens=java.base/sun.nio.ch=ALL-UNNAMED`

|label:new[Introduced in 5.23] `server.jvm.additional=--enable-native-access=ALL-UNNAMED`
|Enables native memory access.

|`server.jvm.additional=-Dlog4j2.disable.jmx=true`
|Disables logging JMX endpoint.

|label:new[Introduced in Neo4j 5.26] `server.jvm.additional=-Dlog4j.layout.jsonTemplate.maxStringLength=32768`
