...
The Neo4j CloudFormation template's code is available on link:https://github.com/neo4j-partners/amazon-cloud-formation-neo4j/blob/main/ee/neo4j-ee.template.yaml[GitHub].
