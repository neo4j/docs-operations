...
The Neo4j Marketplace listings (and listings on GitHub) use CloudFormation templates which include a user-data (post-install) script to deploy and configure Neo4j.
====
