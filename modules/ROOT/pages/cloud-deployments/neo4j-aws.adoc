...
The AWS Marketplace listing uses the https://github.com/neo4j-partners/amazon-cloud-formation-neo4j/tree/main/marketplace/neo4j.template.yaml[Neo4j CloudFormation template] (hosted in the https://github.com/neo4j-partners/amazon-cloud-formation-neo4j/tree/main/marketplace[neo4j-partners] public GitHub repository), which can be customized to meet more complex use cases.
