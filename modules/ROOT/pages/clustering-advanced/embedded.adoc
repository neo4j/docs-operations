...
[NOTE]
For a detailed tutorial on how to embed Neo4j in your Java application, see link:/docs/java-reference/4.4/java-embedded/setup#java-embedded-setup[Neo4j Java Reference -> Including Neo4j in your project].
