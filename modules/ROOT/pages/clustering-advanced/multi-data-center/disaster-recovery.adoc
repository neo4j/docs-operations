...
. Seed a new cluster (in the current example, two new cores) using the backup from the read-only cluster, as described in xref:clustering/seed.adoc[Seed a cluster].
