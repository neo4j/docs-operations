...
See thelink:{neo4j-docs-base-uri}/driver-manual/1.7/client-applications#driver-connection-uris[Driver Manual] for instructions on how to configure drivers to use custom load balancing.
====
