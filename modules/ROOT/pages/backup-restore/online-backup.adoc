...
* Modify the memory settings in the _neo4j.conf_ file::

You can also use the `--additional-config` option of the `neo4j-admin database backup` command to override the memory configurations in the _neo4j.conf_ file.
