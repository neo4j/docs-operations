...
For more information, see xref:performance/disks-ram-and-other-tips/#performance-checkpoint-iops-limit[Checkpoint IOPS limit].

Periods of high traffic may also impact the duration of checkpointing -- and thus the success of a backup job.
