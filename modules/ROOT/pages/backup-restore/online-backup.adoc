...
The xref:data-integrity.adoc#transaction-log-files[transaction log files], which keep track of recent changes, are rotated and pruned based on a provided configuration.
