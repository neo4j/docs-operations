...
<<<<<<< HEAD:modules/ROOT/pages/backup-restore/online-backup.adoc
:description: This section describes how to back up an online database. 
=======
>>>>>>> 39d64ed3e... removed abstracts and added descriptions instead (#3210):operationsManual/asciidoc/backup-restore/online-backup.adoc
