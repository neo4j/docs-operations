...
If valid, the backups can be used to xref:scalability/sharded-property-databases/creating-sharded-databases.adoc#creating-sharded-db-from-uri[seed a sharded property database].
