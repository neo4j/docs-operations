...
* xref:backup-restore/validate.adoc[Validate a database backup] -- How to validate a collection of backups.
This command is available only for property-sharded databases.
