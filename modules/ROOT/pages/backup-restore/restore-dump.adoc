...
Starting with Neo4j 5.20, `neo4j-admin database load` command supports loading a database from xref:backup-restore/online-backup.adoc#backup-artifact[full database backup artifacts].
