...
----
bin/neo4j-admin database load --from-path=/full-path/data/dumps neo4j.dump --overwrite-destination=true
----
...
[source,shell, role="nocopy"]
----
bin/neo4j-admin database load --from-path=/full-path/to/backups neo4j.backup --overwrite-destination=true
----
...
[source,shell, role="nocopy"]
----
bin/neo4j-admin database load mydatabase.dump --from-path=s3://myBucket/myDirectory/ --overwrite-destination=true
----
======
...
[source,shell]
----
bin/neo4j-admin database load mydatabase.dump --from-path=gs://myBucket/myDirectory/ --overwrite-destination=true
----
======
=====
