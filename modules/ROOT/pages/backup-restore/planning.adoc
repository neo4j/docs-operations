...
The backup itself does not take overly long, but the xref:tools/neo4j-admin/consistency-checker.adoc[consistency check] can take much more time to complete, depending on the store.
