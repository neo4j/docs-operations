...
It dumps a database into a single-file archive, called _<database>.dump_, and stores it in the xref:configuration/file-locations.adoc#data[_<neo4j-home>/data_] directory.
