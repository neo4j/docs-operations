...
Starting with Neo4j 5.20, you can load a full database backup artifact using xref:backup-restore/restore-dump.adoc#restore-dump-command[`neo4j-admin database load` command] as well.
This is available in the Community Edition.
