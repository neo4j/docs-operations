...
. Restore a database backup created in the section xref:backup-restore/online-backup.adoc#online-backup-example[Back up an online database]. The backup artifact is located in the `/tmp/mybackups` directory.
...
[source,shell]
----
bin/neo4j-admin database restore --from-path=/tmp/backups/neo4j-2023-05-05T11-26-38.backup mydatabase
----
...
The backup artifacts are located in the `/tmp/mybackups` directory.
...
. In a different `shell` terminal, inspect the backup artifacts in the _/tmp/mybackups_ directory:
+
[source,shell, role="noplay"]
----
bin/neo4j-admin database backup --inspect-path=/tmp/mybackups
----
+
...
| file:///tmp/mybackups/neo4j-2023-06-29T14-46-27.backup |    neo4j | c8368b24-55e2-474d-bb41-75657f5bfcde | 2023-06-29T13:46:27 |  true |       true |         1 |         11 |
| file:///tmp/mybackups/neo4j-2023-06-29T14-50-45.backup |    neo4j | c8368b24-55e2-474d-bb41-75657f5bfcde | 2023-06-29T13:50:45 | false |       true |        12 |         14 |
| file:///tmp/mybackups/neo4j-2023-06-29T14-51-33.backup |    neo4j | c8368b24-55e2-474d-bb41-75657f5bfcde | 2023-06-29T13:51:33 | false |       true |        15 |         18 |
----
+
...
[source,shell, role="noplay"]
----
bin/neo4j-admin database restore --from-path=/tmp/mybackups/neo4j-2023-06-29T14-50-45.backup --restore-until="2023-06-29 13:50:45"
----
+
