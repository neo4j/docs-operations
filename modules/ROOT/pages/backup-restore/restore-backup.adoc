...
=== Restore a database backup on a standalone server
...
To restore a database from a backup in a clustered environment, you can use one of the following methods:
