...
To restore a database from a backup in a <<cluster, clustered environment>>, use one of the following methods:
...
The restore recovers transactions that were <<commit, committed>> before the provided timestamp.
|
