...
+
[TIP]
If you want to change the database name, you can rename both directories _data/databases/my-database_ and _data/transactions/my-database_ to _data/databases/new-database-name_ and _data/transactions/new-database-name_.
+
[source, cypher, role="noplay"]
----
