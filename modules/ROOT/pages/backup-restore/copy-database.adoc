...
[TIP]
====
If you want to change the database name, you can rename both directories _data/databases/database-copy_ and _data/transactions/database-copy_ to _data/databases/new-database-name_ and _data/transactions/new-database-name_, and run the `CREATE DATABASE new-database-name` command.
====
