...
|--property-shard-count=<propertyShardCount>footnote:shardedDb[See xref:scalability/sharded-property-databases/resharding-databases.adoc[Property Sharding -> Resharding databases] for details.]
