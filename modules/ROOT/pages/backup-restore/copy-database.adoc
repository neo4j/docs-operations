...
[source, shell]
----
bin/neo4j-admin copy --from-database=neo4j --to-database=database-copy
----
...
+
[TIP]
If you want to change the database name, you can rename both directories _data/databases/database-copy_ and _data/transactions/database-copy_ to _data/databases/new-database-name_ and _data/transactions/new-database-name_.
+
[source, cypher]
----
