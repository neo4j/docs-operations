...
|--compress[=true\|false]footnote:shardedDb[See xref:scalability/sharded-property-databases/data-ingestion.adoc#splitting-existing-db-into-shards[Property Sharding -> Splitting an existing database into shards] for details.]
