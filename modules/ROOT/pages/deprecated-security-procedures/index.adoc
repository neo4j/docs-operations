...
It is strongly recommended to migrate to the security features as described in link:{neo4j-docs-base-uri}/cypher-manual/4.4/access-control[Cypher Manual -> Access Control]
