...
It is strongly recommended to migrate to the security features as described in link:{neo4j-docs-base-uri}/cypher-manual/{page-version}/access-control[Cypher Manual -> Access control].
