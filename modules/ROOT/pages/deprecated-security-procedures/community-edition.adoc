...
Please use `ALTER CURRENT USER SET PASSWORD FROM 'oldPassword' TO 'newPassword'`, documented in the link:/docs/cypher-manual/4.4/access-control/manage-users#access-control-alter-password[Cypher Manual], instead.
