...
In this example, you create a user called `alias_user`, which will be used by the remote database alias to connect to `db1`, and share the credentials with _Alice_.
