...
// Reneta: I can't find this one in the codebase:
//----------------------------------------------
...
* xref:configuration/configuration-settings.adoc#config_dbms.routing.driver.connection.connect_timeout[dbms.routing.d*river.connection.connect_timeout]
...
* xref:configuration/configuration-settings.adoc#config_dbms.routing.driver.connection_pool_acquisition_timeout[dbms.routing.driver.connection_pool_acquisition_timeout]
...
The driver settings are set in the `DRIVER` clause of the `CREATE ALIAS` command.
