...
| "library.sci-fi"  | NULL      | "sci-fi-books" | "local"  | NULL                      | NULL    |
...
| "library.sci-fi"  | NULL      | "sci-fi-books" | "local"  | NULL                      | NULL    | NULL                                                                                                                                                                                                           | {}                        |
...
This is equivalent to running `DROP ALIAS `northwind++` IF EXISTS FOR DATABASE `northwind-graph-2021`++` followed by `CREATE ALIAS `northwind++` FOR DATABASE `northwind-graph-2021`++`.
