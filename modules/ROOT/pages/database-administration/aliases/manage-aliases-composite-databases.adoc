...
== Show database aliases in composite databases
...
To run the command, the user must have the `GRANT SHOW ALIAS ON DBMS TO role` privilege on the composite database.
