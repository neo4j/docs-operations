...
In particular, when connected to this database you can only perform a specific set of administrative functions, as described in detail in  xref::database-administration/standard-databases/manage-databases.adoc[Database management].
