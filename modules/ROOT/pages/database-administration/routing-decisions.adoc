...
. link:{neo4j-docs-base-uri}/cypher-manual/5/clauses/use[Cypher `USE` clause]
** Note that link:{neo4j-docs-base-uri}/operations-manual/5/database-administration/[administration commands]  implicitly have `USE system`.
