...
[role=label--new-2025.12 label-cypher-25 not-on-aura]
...
[role=label--new-2026.07 label-cypher-25 not-on-aura]
=== Create a replica database

To create a replica database via the network, use the following command:
...
Starting with 2025.06, `SET DEFAULT LANGUAGE CYPHER {5|25}` is available for both self-managed deployments and Aura.
====

[role=label--new-2025.06 role=not-on-aura]
...
[role=enterprise-edition aura-db-business-critical aura-db-dedicated]
=== Show aliases
