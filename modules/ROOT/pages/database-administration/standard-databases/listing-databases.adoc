...
| writer
|`true` for the server that accepts writes for this database. This is the leader for this database.
| BOOLEAN
| {check-mark}
...
| label:new[Introduced in 2025.12]label:enterprise[Enterprise edition] label:spd[Sharded property databases] Number of property shard replicas for this database reported as running currently.
...
| label:new[Introduced in 2025.12]label:enterprise[Enterprise edition] label:spd[Sharded property databases] The requested number of property shard replicas for this database.
May be lower than current if the DBMS is currently reducing the number of copies of the database, or higher if it is currently increasing the number of copies.
| INTEGER
|
...
| replicationLag
|
Number of transactions the current database is behind compared to the database on the primary host.
...
|shardTxnLag
|label:new[Introduced in 2025.12]label:enterprise[Enterprise edition] label:spd[Sharded property databases] The number of transactions the current shard is behind compared to the most up-to-date shard allocation of the sharded database.
The lag is expressed in negative integers.
| INTEGER
|

|constituents
|The names of any graph shards the database may have. Applicable only for composite databases.
| LIST<STRING>
| {check-mark}

|graphShards
|label:new[Introduced in 2025.12]label:enterprise[Enterprise edition] label:spd[Sharded property databases] The names of any graph shards the database may have. Applicable also for standard databases.
| LIST<STRING>
|

|propertyShards
|label:new[Introduced in 2025.12]label:enterprise[Enterprise edition] label:spd[Sharded property databases] The names of any property shards the database may have.
| LIST<STRING>
|
