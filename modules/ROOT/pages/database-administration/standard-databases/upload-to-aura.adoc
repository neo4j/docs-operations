...
The `neo4j-admin database upload` command uploads a local Neo4j database dump or backup file into a <<aura-instance, Neo4j Aura instance>>.
...
* Verify that your <<aura-instance, Neo4j Aura instance>> is running.
