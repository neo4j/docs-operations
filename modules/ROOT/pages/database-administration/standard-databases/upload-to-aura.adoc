...
The `neo4j-admin database upload` command does not support split backup/dump archives introduced in Neo4j 2026.09.

For details on splitting backup/dump files, see xref:backup-restore/planning.adoc#splitting-backup-archive[Planning backup and restore strategy].
