...
|--to-dbid=<databaseid>
|label:new[Introduced in 2026.08] Database ID of the target database. Required when uploading to a Multi-DB instance, using an instance-based URI (e.g. `*.instances.neo4j.io`).
|
