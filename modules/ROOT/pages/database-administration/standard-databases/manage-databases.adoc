...
For more information, see xref:database-administration/remote-databases/manage-remote-databases.adoc#alias-management-create-database-alias[creating database aliases].
