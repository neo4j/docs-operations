...
For information about modifying access options, see the link:{neo4j-docs-base-uri}/cypher-manual/{page-version}/access-control/dbms-administration[Cypher Manual -> Access control -> DBMS administration]. 
