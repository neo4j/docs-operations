...
For more information on rolling upgrades for causal clusters, see link:{neo4j-docs-base-uri}/upgrade-migration-guide/current/upgrade/upgrade-4.1/causal-cluster/[Upgrade and Migration Guide -> Upgrade a Causal Cluster].
