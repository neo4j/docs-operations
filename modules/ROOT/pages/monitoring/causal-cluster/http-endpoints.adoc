...
For more information, see link:{neo4j-docs-base-uri}/upgrade-migration-guide/current/upgrade/upgrade-4.2/causal-cluster/[Upgrade and Migration Guide -> Upgrade a Causal Cluster].
