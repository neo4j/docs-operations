...
Additionally, you can specify a custom port for the fleet discovery service to listen on by setting xref:configuration/configuration-settings.adoc#config_server.fleet_discovery.port[`server.fleet_discovery.port`] or the broadcast interval by setting xref:configuration/configuration-settings.adoc#config_server.fleet_discovery.broadcast_interval[`server.fleet_discovery.broadcast_interval`].
