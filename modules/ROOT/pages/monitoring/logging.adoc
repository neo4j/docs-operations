...
| _neo4j-admin-import-yyyy-MM-dd.HH.mm.ss.log_ footnote:[See xref:import.adoc#import-logs[Import progress reporting] for details about the updated way of neo4j-admin import logging and reporting issues.]
...
label:changed[Changed in 2026.03] In 2026.03, the import log name and the path to it are updated to `server/data/imports/dbname-yyyy-MM-dd.HH.mm.ss/import.log`
|
|
|===
