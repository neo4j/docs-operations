...
It is highly recommended to keep it enabled and not to alter the debug.log format.
If you require the debug.log messages in a different format, create an additional Appender.
