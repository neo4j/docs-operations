...
label:changed[Changed in 2026.03] The import log name _neo4j-admin-import-yyyy-MM-dd.HH.mm.ss.log_  is updated to _dbname-yyyy-MM-dd.HH.mm.ss/import.log_.
The path to it is changed from `server/logs` to `server/data/imports/`. +
