...
| _dbname-yyyy-MM-dd.HH.mm.ss/import.log_ footnote:[See xref:import/import-logs.adoc[Import progress reporting] for details about the updated way of neo4j-admin import logging and reporting issues.]
