...
To learn more about the deprecated and removed metrics in 2025.x, refer to the page xref:changes-deprecations-removals.adoc[].
...
|===
|Name |Description
|<prefix>.database.<database-name>.pool.<pool-name>.<database-name>.used_heap|Used or reserved heap memory in bytes. (gauge)
|<prefix>.database.<database-name>.pool.<pool-name>.<database-name>.used_native|Used or reserved native memory in bytes. (gauge)
|<prefix>.database.<database-name>.pool.<pool-name>.<database-name>.total_used|Sum total used heap and native memory in bytes. (gauge)
|<prefix>.database.<database-name>.pool.<pool-name>.<database-name>.total_size|Sum total size of capacity of the heap and/or native memory pool. (gauge)
|<prefix>.database.<database-name>.pool.<pool-name>.<database-name>.free|Available unused memory in the pool, in bytes. (gauge)
|===
