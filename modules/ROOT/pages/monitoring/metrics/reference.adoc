...
|<prefix>.page_cache.pages_snapshot_loaded|The total number of old page snapshot loads happened in the page cache. (counter)
|<prefix>.page_cache.async_submit|The total number of page async io submit happened in the page cache. (counter)
|<prefix>.page_cache.async_complete|The total number of page async io complete happened in the page cache. (counter)
|<prefix>.page_cache.async_failure|The total number of page async io failure happened in the page cache. (counter)
|===
