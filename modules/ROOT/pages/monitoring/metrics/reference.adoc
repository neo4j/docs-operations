...
To learn more about the deprecated and removed metrics, see xref:deprecations.adoc[Deprecations in Neo4j 2025-2026 series] and xref:breaking-changes.adoc[Breaking changes in Neo4j 2025-2026 series].
