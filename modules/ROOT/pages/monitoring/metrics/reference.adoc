...
|===
|Name |Description
|<prefix>.org.neo4j.genai.vector.DeprecatedVectorEncoding|The function/procedure genai.vector.encode(Batch) was called. (counter)
|<prefix>.org.neo4j.genai.ai.text.completion.TextCompletionCallCountersMonitor|The function/procedure ai.text.complete was called. (counter)
...
|<prefix>.org.neo4j.genai.ai.text.embed.VectorEmbedding|The function/procedure ai.text.embed(Batch) was called. (counter)
|===
