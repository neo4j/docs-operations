...
[[cypher-metrics]]
=== Cypher planning and caching metrics

For more information about this topic, refer to the link:{neo4j-docs-base-uri}/cypher-manual/current/planning-and-tuning[Cypher Manual -> Query plans, tuning, and caching].

.Cypher planning and cache metrics
[options="header",cols="<3m,<4"]
|===
| Name
| Description
...
| cypher_cache_executable_query_hits_total
| The total number of executable query cache hits. (counter)

| cypher_cache_executable_query_misses_total
| The total number of executable query cache misses. (counter)

| cypher_cache_executable_query_cache_flushes_total
...
| cypher_cache_executable_query_discards_total
| The total number of entries evicted from the executable query cache. (counter)

| cypher_cache_executable_query_compiled_total
...
| cypher_cache_executable_query_entries
| The current number of entries in the executable query cache. (gauge)

| cypher_cache_executable_query_stale_entries_total
