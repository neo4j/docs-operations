...
|<prefix>.transaction.committed|The total number of <<commit, committed>> transactions. Informational, not an indication of any issue. Spikes or large increases indicate large data loads or just high read load. (counter)
