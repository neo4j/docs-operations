...
// |===
// |Name |Description
// |<prefix>.org.neo4j.genai.vector.DeprecatedVectorEncoding|label:deprecated[Deprecated in 2025.11] The function/procedure genai.vector.encode(Batch) was called. (counter)
// |<prefix>.org.neo4j.genai.ai.text.completion.TextCompletionCallCountersMonitor|label:new[Introduced in 2025.11] The function/procedure ai.text.complete was called. (counter)
// |<prefix>.org.neo4j.genai.dbs.VectorDatabases|The function/procedure for external vector database integration was called. (counter)
// |<prefix>.org.neo4j.genai.ai.text.embed.VectorEmbedding|label:new[Introduced in 2025.11] The function/procedure ai.text.embed(Batch) was called. (counter)
// |===
