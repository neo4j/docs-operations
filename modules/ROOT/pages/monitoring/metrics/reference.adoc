...
|<prefix>.dbms.bolt.worker_thread_bound_time|label:new[Introduced in 5.21]The amount of time in milliseconds that worker threads spent bound to a given connection
