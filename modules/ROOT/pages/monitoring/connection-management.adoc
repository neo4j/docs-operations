...
The procedure `dbms.listConnections` shows all accepted network connections for all configured connectors, including <<bolt-protocol, Bolt>>, HTTP, and HTTPS.
...
|===
| <<bolt-protocol, Bolt>> connections are stateful.
