...
|Address of the DBMS to connect to, including the scheme (e.g. _bolt://localhost:7687_ or
_bolt+ssc://localhost:7687_). Defaults to an address derived from the Neo4j configuration.
|
