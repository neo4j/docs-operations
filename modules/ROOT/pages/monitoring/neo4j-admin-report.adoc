...
In Neo4j Enterprise Edition, to create a role with the minimum required privileges to run the `neo4j-admin server report` command, you can use the following Cypher statement:
