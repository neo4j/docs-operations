...
| link:{neo4j-docs-base-uri}/cypher-manual/5/planning-and-tuning/runtimes/concepts/#runtimes-parallel-runtime[Parallel Cypher runtime]
|
| {check-mark}
...
| link:{neo4j-docs-base-uri}/cypher-manual/5/indexes/[Fast writes via native label indexes]
| {check-mark}
| {check-mark}
...
| link:{neo4j-docs-base-uri}/cypher-manual/5/indexes/semantic-indexes/vector-indexes/[Vector indexes]
| {check-mark}
| {check-mark}
