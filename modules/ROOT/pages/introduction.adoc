...
Infinigraph is a special Enterprise Edition, which includes all features from Enterprise edition, as well as unlimited horizontal scaling with automatic sharding, and Graph Data Science and Neo4j Bloom with license keys.
