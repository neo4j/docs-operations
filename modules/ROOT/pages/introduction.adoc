...
Infinigraph is a special Enterprise Edition that also includes unlimited horizontal scaling with automatic sharding, as well as Graph Data Science and Neo4j Bloom with license keys.
...
| Support for link:https://neo4j.com/docs/graph-data-science/current/installation/installation-enterprise-edition/[Neo4j Graph Data Science Enterprise Edition] footnote:license[Infinigraph includes license keys for Neo4j Graph Data Science and Bloom.]
|
| {check-mark}
| {check-mark}

| Support for link:https://neo4j.com/docs/bloom-user-guide/current/[Neo4j Bloom] footnote:license[]
|
| {check-mark}
| {check-mark}
