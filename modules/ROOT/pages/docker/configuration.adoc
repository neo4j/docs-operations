...
For details on how to configure _user-logs.xml_ and _server-logs.xml_ files, see xref:monitoring/logging.adoc#_default_logging_configuration[Configure Neo4j logging].

After adjusting _user-logs.xml_ and _server-logs.xml_ files, mount the _/conf_ volume into the Docker container.
