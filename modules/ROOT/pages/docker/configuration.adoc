...
[NOTE]
====
For production use it is recommended to use one of the two latter methods, replacing the entire configuration. This provides stability in the face of changes or additions to the default configuration in the image.
====
