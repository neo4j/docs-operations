...
If you need to adjust the Neo4j logging configuration in the Docker container, follow the steps.
...
----
+
Note that `query.log` and `security.log` are part of the Enterprise Edition.
