...
If you rely on the `NEO4J_PLUGINS` environment variable, ensure you map explicit host permissions to avoid container folder ownership blocks and override the server directory mappings inside your environmental configuration:
