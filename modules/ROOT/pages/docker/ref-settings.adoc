...
To configure these settings in Docker, you either set them in the _neo4j.conf_ file, or pass them to Docker as Docker environment variables.

In Neo4j, the SSL policies are configured by assigning values to parameters of the following format:
