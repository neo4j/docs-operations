...
* `ssl.policy.bolt.base_directory` -> `+NEO4J_dbms_ssl_policy_bolt_base__directory+`
...
| `db.cluster.backup.pull_interval` label:new[Introduced in 2026.06]
...
| `db.memory.pagecache.warmup.order` label:new[Introduced in 2026.03]
...
| `dbms.bolt.local_connector.object_transport_enabled` label:new[Introduced in 2026.09]
| `+NEO4J_dbms_bolt_local__connector_object__transport__enabled+`
...
| `dbms.cypher.transactions.default_subquery_batch_strategy` label:new[Introduced in 2026.05]
...
| `server.directories.seeds` label:new[Introduced in 2026.04]
...
| `server.fleet_discovery.broadcast_interval` label:new[Introduced in 2026.05]
| `+NEO4J_server_fleet__discovery_broadcast__interval+`

| `server.fleet_discovery.broadcast_interval_jitter` label:new[Introduced in 2026.05]
| `+NEO4J_server_fleet__discovery_broadcast__interval__jitter+`

| `server.fleet_discovery.enabled` label:new[Introduced in 2026.05]
| `+NEO4J_server_fleet__discovery_enabled+`

| `server.fleet_discovery.port` label:new[Introduced in 2026.05]
...
| `server.http.x_forward.allow_hosts` label:new[Introduced in 2026.03]
| `+NEO4J_server_http_x__forward_allow__hosts+`

| `server.http.x_forward.allow_proxies` label:new[Introduced in 2026.03]
| `+NEO4J_server_http_x__forward_allow__proxies+`

| `server.http.x_forward.enabled` label:new[Introduced in 2026.03]
| `+NEO4J_server_http_x__forward_enabled+`

| `server.http.x_forward.private_ips_enabled` label:new[Introduced in 2026.03]
...
| `server.memory.pagecache.async` label:new[Introduced in 2026.04]
...
| `server.split_archive.part_size` label:new[Introduced in 2026.09]
| `+NEO4J_server_split__archive_part__size+`
