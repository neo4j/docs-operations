...
* link:{neo4j-docs-base-uri}/upgrade-migration-guide/current/upgrade/upgrade-4.1/deployment-upgrading[Upgrade and Migration Guide -> Upgrade a single instance]
* link:{neo4j-docs-base-uri}/upgrade-migration-guide/current/upgrade/upgrade-4.1/causal-cluster/[Upgrade and Migration Guide -> Upgrade a Causal Cluster]
