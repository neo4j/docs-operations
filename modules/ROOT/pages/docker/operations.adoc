...
To install link:{neo4j-docs-base-uri}/java-reference/{page-version}/extending-neo4j/procedures/[user-defined procedures], mount the _/plugins_ volume containing the jars.
