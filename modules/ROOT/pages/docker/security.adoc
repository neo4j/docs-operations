...
Neo4j on Docker supports Neo4j's native xref:security/ssl-framework.adoc[SSL Framework] for setting up secure <<bolt-protocol, Bolt>> and HTTPS communications.
