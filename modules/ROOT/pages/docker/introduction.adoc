...
Starting with 5.26.25, `debian:bullseye-slim` and `redhat/ubi9-minimal:latest` are not supported.
...
[NOTE]
====
* The Red Hat UBI9 variant images are only available for Neo4j 5.17.0-5.26.24.
