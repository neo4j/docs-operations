...
<2> To prevent broken plugin lookups, keep the plugins volume mapping and add the matching configuration path under your environment variables: `- NEO4J_server_directories_plugins=/plugins`.
