...
<2> To prevent broken plugin lookups or permission errors, add the strict configuration path mapping directly under the environment variables: `- NEO4J_server_directories_plugins=/plugins`.
