...
[NOTE]
====
* Ubuntu Server 22.04,  macOS 15 (Sequoia), CentOS Stream 9, and Windows Server 2022 are deprecated as of 2026.05, with support for these platforms being removed in a future release.
