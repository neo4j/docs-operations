...
| *Debian 11, 12, 13*                                    | OpenJDK 21/25, OracleJDK 21/25, and ZuluJDK 21/25
| *Red Hat Enterprise Linux Server 8.x, 9.x*             | Red Hat OpenJDK 21/25,  Oracle JDK 21/25, and ZuluJDK 21/25
...
Neo4j {neo4j-version-exact} is built and tested against RHEL 8.10 and 9.6, and assumes compatibility across other minor releases within the RHEL 8.x and 9.x major versions.
