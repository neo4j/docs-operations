...
| *Amazon Linux 2023 AMI*                                | Amazon Corretto 21/25, OracleJDK 21/25, and Eclipse Temurin 21/25
| *CentOS Stream 8, 9, 10*                               | OpenJDK 21/25, OracleJDK 21/25, ZuluJDK 21/25, and Eclipse Temurin 21/25
| *Debian 11, 12, 13*                                    | OpenJDK 21/25, OracleJDK 21/25, ZuluJDK 21/25, and Eclipse Temurin 21/25
| *Red Hat Enterprise Linux Server 8.x, 9.x, 10.x*       | Red Hat OpenJDK 21/25,  Oracle JDK 21/25, ZuluJDK 21/25, and Eclipse Temurin 21/25
| *Ubuntu Server 22.04, 24.04*                           | OpenJDK 21/25, OracleJDK 21/25, ZuluJDK 21/25, and Eclipse Temurin 21/25
| *Windows Server 2022, 2025*                            | OracleJDK 21/25, ZuluJDK 21/25
|===

For more information on Red Hat Enterprise Linux Life Cycle, refer to their link:https://access.redhat.com/support/policy/updates/errata[official documentation].
...
| *SuSE Enterprise Desktop 15*            | OpenJDK 21/25, OracleJDK 21/25, and Eclipse Temurin 21/25
| *Ubuntu Desktop 22.04, 24.04*           | OpenJDK 21/25, OracleJDK 21/25, ZuluJDK 21/25, and Eclipse Temurin 21/25
...
[[deployment-requirements-network]]
== Network

Neo4j supports IPv4, IPv6, and dual-stack (IPv4 and IPv6 simultaneously) network configurations.
The host operating system must have IPv6 enabled and configured on the relevant network interface when using IPv6.

For more information on configuring Neo4j with IPv6, see your relevant operating system documentation, or xref:configuration/connectors.adoc[Configure network connectors].
