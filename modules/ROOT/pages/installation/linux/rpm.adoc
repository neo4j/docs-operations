...
----
You have to accept the link:https://neo4j.com/terms/licensing/[commercial license] before the interactive installation is allowed to complete.
+
...
For a non-interactive installation, you can set the environment variable `NEO4J_ACCEPT_LICENSE_AGREEMENT` to `yes` (for the commercial license).
