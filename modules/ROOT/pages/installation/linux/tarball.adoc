...
If it is not already installed, get link:https://openjdk.org/[OpenJDK 21], link:https://www.azul.com/downloads/[ZuluJDK 21], or link:https://www.oracle.com/java/technologies/downloads/?er=221886[Oracle Java 21].
