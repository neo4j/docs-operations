...
For information about Cypher's property types, see the link:{neo4j-docs-base-uri}/cypher-manual/25/values-and-typesproperty-structural-constructed/#property-types[Cypher Manual -> Property types].
