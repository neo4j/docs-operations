...
| *Mode* 3+| READ
| *Replaced by* 3+| the Cypher clause `SEARCH`. For more information, see the link:{neo4j-docs-base-uri}/cypher-manual/current/clauses/search/[Cypher Manual -> SEARCH].
|===
...
| *Mode* 3+| READ
| *Replaced by* 3+| the Cypher clause `SEARCH`.
|===
