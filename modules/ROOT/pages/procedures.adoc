...
For more information, see link:{neo4j-docs-base-uri}/aura/fleet-management/setup/[Fleet management].
...
| *Description* 3+a| Disable fleet management
.2+| *Return arguments* | *Name* | *Type* | *Description*
| `result` | `STRING` | A message indicating the result of the operation
| *Mode* 3+| DBMS
|===
...
| *Description* 3+a| Inspect the Neo4j Fleet Management token to validate
.2+| *Input arguments* | *Name* | *Type* | *Description*
...
| *Description* 3+a| Add a token for authenticating to Neo4j Fleet Management
.2+| *Input arguments* | *Name* | *Type* | *Description*
...
| *Description* 3+a| Generate documentation for the data structures used in fleet management messages
.6+| *Return arguments* | *Name* | *Type* | *Description*
...
| *Description* 3+a| Restart fleet management
.2+| *Return arguments* | *Name* | *Type* | *Description*
| `result` | `STRING` | A message indicating the result of the operation
| *Mode* 3+| DBMS
|===
...
| *Description* 3+a| Check the status of fleet management
.4+| *Return arguments* | *Name* | *Type* | *Description*
| `active` | `BOOLEAN` | Is fleet management active?
| `connected` | `BOOLEAN` | Is fleet management connected?
| `statusMessage` | `STRING` | Error message if fleet management is not connected
| *Mode* 3+| READ
|===
