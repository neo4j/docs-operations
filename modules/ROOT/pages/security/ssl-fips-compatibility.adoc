...
After this date, all the FIPS 140-2 certificates will be moved to the historical list.
...
* Verify that the machine running Neo4j has FIPS 140-3 compatible hardware and operating system.
