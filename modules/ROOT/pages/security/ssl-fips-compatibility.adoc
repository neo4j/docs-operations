...
[NOTE]
====
FIPS 140-2 will reach EOL on September 21, 2026, and all the FIPS 140-2 certificates will be placed on the historical list.
You should audit your active systems and migrate to FIPS 140-3 validated alternatives.

All Neo4j 2025.x and 2026.x versions support FIPS 140-3 compatible SSL encryption.
====
