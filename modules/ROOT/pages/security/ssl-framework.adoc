...
[NOTE]
====
From Neo4j 5.12 on, all required Netty and tcnative files are included in the `/lib` directory.
====

The following table includes detailed information about previous Neo4j versions:
