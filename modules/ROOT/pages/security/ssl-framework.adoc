...
You may use an external tooling, such as Nmap (link:https://nmap.org/download.html):
+
[source, shell]
----
...
Valid values depend on the current JRE and SSL provider.
For Oracle JRE here is the list of supported ones - link:https://docs.oracle.com/en/java/javase/11/docs/specs/security/standard-names.html#jsse-cipher-suite-names[JSSE Cipher Suite Names].
