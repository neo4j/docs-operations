...
The latest version of Neo4j is *v{neo4j-version-minor}*.
...
For more information, see the new chapter on xref:composite-databases/index.adoc[Composite databases], which replaces the _Fabric_ chapter from previous versions.
