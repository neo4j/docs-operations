...
[NOTE]
====
Privileges my not be denied to a role that has already been assigned to an auth rule. For more information about auth rules, see xref:authentication-authorization/attribute-based-access-control.adoc[attribute-based access control].
====
