...
+------------------------------------------------------------------------------------------------------------------------------------------------------+
| "REVOKE GRANT ACCESS ON DATABASE * TO $role"       | "GRANTED" | "access" | ["architect", "reader"] | FALSE     | ["salesRule", "engineeringUKRule"] |
| "REVOKE GRANT ACCESS ON DATABASE `neo4j` TO $role" | "GRANTED" | "access" | ["regularAuthRules"]    | FALSE     | ["salesRule", "engineeringUKRule"] |
+------------------------------------------------------------------------------------------------------------------------------------------------------+
