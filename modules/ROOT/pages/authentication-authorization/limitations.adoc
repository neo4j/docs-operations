...
For example, when you use link:{neo4j-docs-base-uri}/cypher-manual/5/indexes/search-performance-indexes/[search-performance indexes] (non–full-text) indexes, queries return the same results they would without any index.
