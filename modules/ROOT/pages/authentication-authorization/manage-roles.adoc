...
----
GRANT ROLE[S] name[, ...]
TO {AUTH RULE authrule[, ...] \| [USER] user[, ...]}
----
...
----
REVOKE ROLE[S] name[, ...]
FROM {AUTH RULE authrule[, ...] \| [USER] user[, ...]}
----
...
Roles can also be revoked from auth rules:

[source, cypher, role=noplay]
----
REVOKE ROLES role1, role2 FROM AUTH RULE authRule1, authRule2, authRule3
----
