:description: Details the DBMS privileges for impersonation.
...
The <<database-management-system, DBMS>> privileges for impersonation can be granted, denied, or revoked like other privileges.
...
To show all privileges for the role `allUserImpersonator` as commands, use the following query:
...
To show all privileges for the role `userImpersonator` as commands, use the following query:
