:description: Details the DBMS privileges for procedure and user-defined function execution.
...
The <<database-management-system, DBMS>> privileges for procedure and user-defined function execution can be granted, denied, or revoked like other privileges.
