...
You can manage <<database-management-system, DBMS>> privileges using either the built-in `admin` role or by creating a custom role with the specific privileges you need.
