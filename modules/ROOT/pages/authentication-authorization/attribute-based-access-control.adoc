...
Creating an auth rule that temporarily granting assigned roles based on the value of a claim and the time being between 1900 and 2000 can be done as follows:
...
Assigning roles to the auth rules created in the examples above can be done as follows:
