...
This second risk can be mitigated by using xref:authentication-authorization/auth-providers.adoc[user auth providers], which link each externally authenticated identity to a native user whose tags can then be resolved.
