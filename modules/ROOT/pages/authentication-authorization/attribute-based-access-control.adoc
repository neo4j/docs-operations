...
see xref:authentication-authorization/dbms-administration.adoc#access-control-dbms-administration-auth-rule-management[DBMS AUTH RULE MANAGEMENT privileges].
====
