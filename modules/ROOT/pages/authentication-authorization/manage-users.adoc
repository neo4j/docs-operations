...
The `SHOW USER METADATA` privilege is additionally required to see the values in the `tags` column returned by `SHOW USERS AS COMMANDS YIELD *`.
Otherwise, the column returns `null`.
