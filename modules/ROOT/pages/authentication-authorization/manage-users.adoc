...
| "CREATE USER jake SET AUTH PROVIDER 'native' { SET ENCRYPTED PASSWORD '1,54f7ae30a86010934978d063a499647a3567babcacab8883326c582b918f0a0c,2b9abbfd9b61f1991872b1a25bd36977c6ce457a6a4f7c56b644c224dcac956f' SET PASSWORD CHANGE NOT REQUIRED }"  |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
----
...
| "CREATE USER jack SET AUTH PROVIDER 'native' { SET ENCRYPTED PASSWORD '1,61ce8efee49f1649c163f65aea6f9d17cc92863a1b9b86ed2787334bb3d525be,0a270f6434fbf4b7dfabae1ff9593b1dfaebace3f16c7866f862822d5866cefb' SET PASSWORD CHANGE NOT REQUIRED } SET AUTH PROVIDER 'oidc1' { SET ID 'jacksIdForOidc1' }" | "native" | {changeRequired: FALSE, password: "***"} |
| "CREATE USER jack SET AUTH PROVIDER 'native' { SET ENCRYPTED PASSWORD '1,61ce8efee49f1649c163f65aea6f9d17cc92863a1b9b86ed2787334bb3d525be,0a270f6434fbf4b7dfabae1ff9593b1dfaebace3f16c7866f862822d5866cefb' SET PASSWORD CHANGE NOT REQUIRED } SET AUTH PROVIDER 'oidc1' { SET ID 'jacksIdForOidc1' }" | "oidc1"  | {id: "jacksIdForOidc1"}                  |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
----
