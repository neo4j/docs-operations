...
A home database is resolved if it is pointing to a database or a database alias. Constituents, graph or property shards are not supported as a home database.
...
A home database is resolved if it is pointing to a database or a database alias. Constituents and shards are not supported.
