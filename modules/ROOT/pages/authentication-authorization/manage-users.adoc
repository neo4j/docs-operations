...
Tags are arbitrary labels attached to the native user object that can be evaluated in xref:authentication-authorization/attribute-based-access-control.adoc[attribute-based access control (ABAC)] auth rules through the `link:{neo4j-docs-base-uri}/cypher-manual/current/functions/security/#functions-native_tags[abac.native.user_tags()]` function.
...
Tags can be evaluated in xref:authentication-authorization/attribute-based-access-control.adoc[attribute-based access control (ABAC)] auth rules using the `link:{neo4j-docs-base-uri}/cypher-manual/current/functions/security/#functions-native_tags[abac.native.user_tags()]` function.
...
The tags can be evaluated in xref:authentication-authorization/attribute-based-access-control.adoc[attribute-based access control (ABAC)] auth rules through the `link:{neo4j-docs-base-uri}/cypher-manual/current/functions/security/#functions-native_tags[abac.native.user_tags()]` function.
