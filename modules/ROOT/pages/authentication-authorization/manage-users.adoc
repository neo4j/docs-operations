...
Tags are arbitrary labels attached to the native user object that can be evaluated in xref:authentication-authorization/attribute-based-access-control.adoc[attribute-based access control (ABAC)] auth rules through the `abac.native.user_tags()` function.
...
Tags can be evaluated in xref:authentication-authorization/attribute-based-access-control.adoc[attribute-based access control (ABAC)] auth rules using the `abac.native.user_tags()` function.
...
The tags can be evaluated in xref:authentication-authorization/attribute-based-access-control.adoc[attribute-based access control (ABAC)] auth rules through the `abac.native.user_tags()` function.
