...
When connected to the <<database-management-system, DBMS>> over xref:configuration/connectors.adoc[Configure network connectors], administrative commands are automatically routed to the `system` database.
