...
<<<<<<< HEAD:modules/ROOT/pages/configuration/password-and-user-recovery.adoc
=======
[[recover-admin-role]]
...
>>>>>>> 27a31fa (Moving the password page to auth (#1260)):modules/ROOT/pages/authentication-authorization/password-and-user-recovery.adoc
[[post-recovery]]
== Post-recovery steps
