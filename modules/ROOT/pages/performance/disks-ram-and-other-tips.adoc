...
The files that you want to prefetch can be filtered using the xref:reference/configuration-settings.adoc#config_dbms.memory.pagecache.warmup.preload.whitelist[`dbms.memory.pagecache.warmup.preload.whitelist`] setting.
