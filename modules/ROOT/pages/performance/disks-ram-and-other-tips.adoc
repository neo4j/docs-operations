...
Neo4j supports asynchronous I/O using the Linux kernel system call interface.
...
This initial delivery enables the background page evictor and checkpointer to take advantage of async I/O when available and configured.
