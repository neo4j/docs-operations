...
For more information, see link:{neo4j-docs-base-uri}/cypher-manual/5/planning-and-tuning/query-tuning/[Cypher Manual -> Query tuning] and link:{neo4j-docs-base-uri}/cypher-manual/5/planning-and-tuning/execution-plans/[Cypher Manual -> Execution plans].
====
...
xref:procedures/built-in-procedures.adoc#procedure_db_resampleIndex[`db.resampleIndex()`]::
...
xref:procedures/built-in-procedures.adoc#procedure_db_resampleOutdatedIndexes[`db.resampleOutdatedIndexes()`]::
...
xref:procedures/built-in-procedures.adoc#procedure_db_clearQueryCaches[`db.clearQueryCaches()`]::
...
xref:procedures/built-in-procedures.adoc#procedure_db_prepareForReplanning[`db.prepareForReplanning()`]::
...
* link:{neo4j-docs-base-uri}/cypher-manual/5/planning-and-tuning/query-tuning/#cypher-replanning[Cypher manual -> Cypher replanning]
* link:{neo4j-docs-base-uri}/cypher-manual/5/planning-and-tuning/execution-plans/[Cypher manual -> Execution plans]
* xref:procedures/built-in-procedures.adoc[Procedures]
