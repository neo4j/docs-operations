...
+
The heap memory size is determined by the parameters `<<config_server.memory.heap.initial_size, server.memory.heap.initial_size>>` and `<<config_server.memory.heap.max_size, server.memory.heap.max_size>>`.
