...
For further details on creating, querying, and dropping indexes, see link:{neo4j-docs-base-uri}/cypher-manual/5/indexes/search-performance-indexes/[Cypher Manual -> Indexes for search performance], link:{neo4j-docs-base-uri}/cypher-manual/5/indexes/semantic-indexes/full-text-indexes/[Full-text indexes],  and  link:{neo4j-docs-base-uri}/cypher-manual/5/indexes/semantic-indexes/vector-indexes/[Vector indexes].
...
For more information on configuring point index, refer to link:{neo4j-docs-base-uri}/cypher-manual/5/indexes/search-performance-indexes/[Cypher Manual -> Indexes for search performance].
...
For more information on the different index types, refer to link:{neo4j-docs-base-uri}/cypher-manual/5/indexes/search-performance-indexes/[Cypher Manual -> Indexes for search performance].
