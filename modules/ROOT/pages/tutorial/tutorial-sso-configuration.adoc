...
The setting mandates that users representing the corresponding auth provider must exist in the database to be able to authenticate and authorize using an SSO (or any external) provider.
