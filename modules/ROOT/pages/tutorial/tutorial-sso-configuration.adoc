...
This example shows how to configure Neo4j to use Entra ID access token for authentication and authorization.
...
[source, properties]
----
dbms.security.oidc.azure.audience=api://4376dc8b-b5af-424f-9ada-c1c1b2d416b9
