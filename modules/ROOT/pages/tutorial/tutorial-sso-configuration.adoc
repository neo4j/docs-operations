...
Decide whether you want to use Entra AD Groups directly or Entra App Roles.
...
Entra App Roles allow a layer of separation between Neo4j roles and AD Groups.
...
==== Using Entra AD Groups directly
...
. Configure a mapping from Entra Ad Group Object IDs to Neo4j roles.
