...
[NOTE]
====
The following configurations are crafted for a Neo4j Browser served on _\http://localhost:7474/browser/_ (the default URL when starting the database on `localhost`).
...
For details, see link:https://learn.microsoft.com/en-us/azure/active-directory/develop/id-tokens[Microsoft documentation] as well as the link:https://openid.net/specs/openid-connect-core-1_0.html#ClaimStability[OpenId spec].
====
+
[source, properties]
----
...
Details about Entra ID App Roles can be found in the link:https://learn.microsoft.com/en-us/entra/identity-platform/howto-add-app-roles-in-apps[Microsoft documentation].
