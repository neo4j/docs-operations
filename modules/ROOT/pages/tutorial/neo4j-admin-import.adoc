...
The neo4j-admin import command is used for loading large amounts of data from CSV files and supports full and incremental import into a running or stopped <<database-management-system, DBMS>>.
