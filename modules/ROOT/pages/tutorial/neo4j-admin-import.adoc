...
It is used for loading large amounts of data from CSV files into an **unused non-existing** database and can be used on the local Neo4j instance even if the instance is running or not.
