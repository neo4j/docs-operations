...
Importing data from CSV files with `neo4j-admin database import` can only be done once into an **unused** database, it is used for the initial graph population only.
