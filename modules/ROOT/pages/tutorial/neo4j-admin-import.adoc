...
This page provides examples of importing data from CSV files into a nonexistent database using the xref:import/full-import.adoc[`neo4j-admin database import full`] command.

For examples of importing data into an existing database using the `neo4j-admin database import incremental` command, see xref:import/incremental-import.adoc[Incremental import].
...
* UNIX-styled paths.
* The xref:import/full-import.adoc[`neo4j-admin database import full`] command.
...
The details of a CSV file header format can be found at xref:import/header-format.adoc#import-tool-csv-header-format[CSV header format].
====
...
You can customize the configuration options that the import tool uses (see xref:import/full-import.adoc#_options[Options]) if your data does not fit the default format.
...
The property type is specified in the CSV header row, see xref:import/header-format.adoc#import-tool-csv-header-format[CSV header format].
...
See xref:import/header-format.adoc#import-tool-id-spaces[Using ID spaces].
...
For more information, see the `--skip-bad-relationships` option in xref:import/full-import.adoc#full-import-options-table[`neo4j-admin database import full` options] table.
...
See xref:import/import-logs.adoc[Import progress reporting] for details.
...
For more information, see the `--skip-duplicate-nodes` option in xref:import/full-import.adoc#full-import-options-table[`neo4j-admin database import full` options] table.
