...
Neo4j supports <<cluster, clustering>> in a containerized environment without an orchestration tool.
...
See xref:configuration/configuration-settings.adoc#cluster-settings[Configuration settings] for more details of Neo4j cluster settings.
