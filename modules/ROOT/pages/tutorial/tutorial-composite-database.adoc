...
image::composite-database/northwind-datamodel.svg[title="The Northwind data model", width=350]
...
image::composite-database/northwind-composite-datamodel.svg[title="The new data model", width=800, role=middle]
...
image::composite-database/federation.svg[title="Data Federation", width=350, role=middle]
...
image::composite-database/sharding2.svg[title="Data Sharding", width=450, role=middle]
