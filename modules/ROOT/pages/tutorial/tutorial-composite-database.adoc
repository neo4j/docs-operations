...
The Northwind graph <<data-model>> consists of the following data:
...
+----------------------------------------------------------------------------------------------+
| "compositenw.product"     | "compositenw" | "db0"     | "local"  | null | null        | null |
| "compositenw.customerEU"  | "compositenw" | "db1"     | "local"  | null | null        | null |
| "compositenw.customerAME" | "compositenw" | "db2"     | "local"  | null | null        | null |
+----------------------------------------------------------------------------------------------+
