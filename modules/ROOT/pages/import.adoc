...
|--compress[=true\|false]footnote:shardedDb1[See xref:scalability/sharded-property-databases/data-ingestion.adoc[Property Sharding -> Data ingestion] for details.]
