...
Starting with 2026.03, you can see the detailed logging of import progress for both `neo4j-admin database import` commands.
...
For CSV data, this value must be a different value to the one specified in the '--delimiter' option.
...
You can specify individual constraint statements, or starting with 2026.05 for full import and 2026.06 for incremental import, you can specify a graph type using an `ALTER CURRENT GRAPH TYPE` statement.
