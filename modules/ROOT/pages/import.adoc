...
If you are using a compatible version of Java, you can uncomment the following value of the xref:configuration/configuration-settings.adoc#config_server.jvm.additional[`server.jvm.additional`] setting in the _neo4j.conf_ file:
