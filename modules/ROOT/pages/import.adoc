...
----
Starting to import, output will be saved to: /logs/neo4j-admin-import-2026-02-05.10.25.27.log
...
specified by " + BAD_TOLERANCE_OPTION + " and the
|false
| {check-mark}
| {check-mark}
...
[result, subs="attributes+,+macros"]
----
Starting to import, output will be saved to: /logs/neo4j-admin-import-2026-02-05.10.25.28.log
Neo4j version: {neo4j-version-exact}
Checking the contents of the following files:
Nodes:
