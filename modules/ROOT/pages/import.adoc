...
----
neo4j-admin database import full [-h] [--expand-commands] [--verbose]
                                 ...
                                 [--skip-bad-relationships[=true|false]] [--skip-duplicate-nodes[=true|false]] [--strict[=true|false]] [--trim-strings[=true|false]] [--additional-config=<file>] [--array-delimiter=<char>] [--bad-tolerance=<num>] [--delimiter=<char>]
                                 ...
                                 [--max-off-heap-memory=<size>] [--property-shard-count=<numSpdPropertyDataShards>]
                                 ...
                                 <files>... [--nodes=[<label>[:<label>]...=]<files>...]... [--relationships=[<type>=]
...
|--property-shard-count=<numSpdPropertyDataShards>footnote:spd[See xref:scalability/sharded-property-databases/data-ingestion.adoc[Property Sharding -> Data ingestion] for details.]
...
|--target-format=<format>footnote:spd[]
|label:new[Introduced in 2025.12]label:enterprise[Enterprise edition] Target format can be either plain database directory/files structure or a backup artifact. Uses the `--temp-path` location to keep any intermediate state.
|database
| {check-mark}
|

|--target-location=<path>footnote:spd[]
...
neo4j-admin database import incremental [-h] [--expand-commands] --force [--update-all-matching-relationships]
                                        ...
                                        --nodes=[<label>[:<label>]...=]<files>... [--nodes= [<label>[:<label>]...=]<files>...]... [--relationships=[<type>=]<files>...]... [--multiline-fields=true|false|<path>[,<path>]
                                        [--multiline-fields-format=v1|v2]] <database>
----
...
|--property-shard-count=<numSpdPropertyDataShards>footnote:spd2[See xref:scalability/sharded-property-databases/data-ingestion.adoc[Property Sharding -> Data ingestion] for details.]
...
|--target-format=<format>footnote:spd2[]
|label:new[Introduced in 2025.12]label:enterprise[Enterprise edition] Target format can be either plain database directory/files structure or a backup artifact. Uses the `--temp-path` location to keep any intermediate state.
|database
| {check-mark}
|

|--target-location=<path>footnote:spd2[]
|label:new[Introduced in 2025.12]label:enterprise[Enterprise edition] Location for target backup artifact data. Used together with `--target-format=backup`.
|
| {check-mark}
|
