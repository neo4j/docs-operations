...
The directory that the `neo4j-admin database import` command creates to stores information about the import process, is moved from _server/data/imports_ to _server/logs/_.
