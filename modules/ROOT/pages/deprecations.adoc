...
This section lists all deprecated Neo4j server features, including replacements where applicable.
...
| {check-mark}
| {check-mark}
| label:deprecated[Deprecated in in Cypher 25 since 2026.04] +
Replaced by the Cypher clause `SEARCH`.
