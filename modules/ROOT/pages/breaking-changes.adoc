...
For guidelines on how to migrate from previous Neo4j versions to {neo4j-version}, see the link:https://neo4j.com/docs/upgrade-migration-guide/current/version-2025[Upgrade and Migration Guide].
