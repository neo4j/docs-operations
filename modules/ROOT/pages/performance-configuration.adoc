...
A full description on how to create and use full-text indexes is provided in the link:{neo4j-docs-base-uri}/cypher-manual/4.1/administration/indexes-for-full-text-search/[Cypher Manual -> Indexes to support full-text search].
