...
<<<<<<< HEAD:modules/ROOT/pages/manage-databases/remote-alias.adoc
...
>>>>>>> e21a490 (Moving the command expansion section to a new page (#1108)):modules/ROOT/pages/database-administration/aliases/remote-database-alias-configuration.adoc
|===
