...
You can use the link:/docs/cypher-manual/4.4/aliases[alias commands] to manage remote database aliases.
...
In order to do so, either link:/docs/cypher-manual/4.4/access-control/dbms-administration#access-control-dbms-administration-database-management[database management]
or link:/docs/cypher-manual/4.4/access-control/dbms-administration#access-control-dbms-administration-alias-management[alias management] privileges are required.
...
* The link:/docs/cypher-manual/4.4/clauses/use[`USE` clause] enables a user to query a remote database alias that they are not directly connected to:
...
See more about link:/docs/cypher-manual/4.4/access-control/dbms-administration#access-control-dbms-administration-user-management[User Management].
