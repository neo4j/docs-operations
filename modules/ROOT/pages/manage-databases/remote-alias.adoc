...
Here is a comparison between a link:https://neo4j.com/docs/operations-manual/4.4/fabric/[Fabric database] and a remote alias database, so you can take a more informed decision about which one to use:
