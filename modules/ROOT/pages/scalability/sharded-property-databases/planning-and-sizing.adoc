...
For example, in commodity virtual or physical hardware, the size of each database should not exceed 1 to 3 TB.
...
* Database resharding, i.e., changing the number of property shards or property shard replicas, can be executed online or offline depending on your requirements and constraints.
See xref:scalability/sharded-property-databases/resharding-databases.adoc[Resharding databases].
