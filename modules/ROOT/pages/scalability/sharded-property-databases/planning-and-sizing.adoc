...
See xref:scalability/sharded-property-databases/resharding-sharded-databases.adoc#splitting-existing-db-into-shards[Splitting an existing database into shards].
