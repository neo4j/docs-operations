...
When this feature becomes generally available, you will need to upgrade to the latest Neo4j version (may require downtime) to use the feature for non-development purposes.
