...
. On one of the servers, copy the data from a backup of your database `foo` into the database `foo-sharded`, creating one graph shard and five property shards.
+
[source, shell]
----
