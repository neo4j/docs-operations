...
You can use the xref:import/full-import.adoc[`neo4j-admin database import full`] command to import data from delimited files into a sharded property database as in a standard Neo4j database.
...
See xref:import/full-import.adoc[Import -> Full import] for more information.
...
Optionally, you can use the `--compress` option label:new[Introduced in 2026.04] to produce compressed backup artifacts.
See xref:import/incremental-import.adoc[Incremental import] for more information and instructions.
+
[source, shell]
----
