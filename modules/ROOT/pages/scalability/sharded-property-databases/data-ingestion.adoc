...
For creating a sharded property database from an existing database or backup, see xref:scalability/sharded-property-databases/creating-sharded-databases.adoc#creating-sharded-db-from-uri[Creating a sharded database from a URI (online)] and xref:scalability/sharded-property-databases/resharding-sharded-databases.adoc[Resharding a database].
