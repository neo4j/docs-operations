...
For details on the command syntax and arguments, see xref:database-administration/standard-databases/listing-databases.adoc[List databases].
...
The columns `shardTxnLag` and `replicationLag` both provide information about how far behind a shard or database is in terms of transactions, but they measure different aspects:
