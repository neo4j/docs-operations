...
GRANT ACCESS ON DATABASE movies2025 TO localAccess;
----
...
[source, cypher]
----
DENY MATCH { description } ON GRAPH movies2025 NODES PG18 TO localAccess
----
...
[source, cypher]
----
// Access the composite database
USE cineasts;
// Access the local constituent
USE cineasts.latest;
// Access the remote constituent
