...
The examples will assume the same setup as the one created in the xref:composite-databases/index.adoc[Introduction]
...
The second part queries for all movies in `cineasts.upcoming` that fulfill our condition and returns them.
