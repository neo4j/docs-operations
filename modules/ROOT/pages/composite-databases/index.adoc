...
They use _database aliases_, which can be local, remote, or sharded.
...
The main concepts that one needs to understand when working with data using Composite databases are:
