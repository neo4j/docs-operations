...
_Catch-up strategy plugins_ are sets of rules that define how secondaries contact upstream database member in the cluster in order to synchronize transaction logs.
