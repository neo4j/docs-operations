...
The configuration of load balancing policies is transparent to <<client-application, client applications>> and expressed via DSL.
...
There are different ways to configure the load balancing for the cluster so that <<client-application, client applications>> can direct their workload to the most appropriate cluster members, such as those nearby.
