...
Depending on the deployment and the available number of database allocations in the cluster, different strategies make sense for whether or not the read workload should be routed to the primary allocations.
