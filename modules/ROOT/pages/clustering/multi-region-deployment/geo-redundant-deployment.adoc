...
To tolerate the failure of any two arbitrary servers or two primaries, your database must have five primary allocations.
...
* Higher write latency (cross-data center).
| Systems that must remain available even during server or full data center failures. 
