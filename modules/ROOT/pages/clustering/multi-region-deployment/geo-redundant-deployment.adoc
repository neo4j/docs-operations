...
=== Recovering from the loss of the upstream cluster

If the source (upstream) cluster becomes unavailable, you can promote a replica database to accept writes.
