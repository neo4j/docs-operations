...
The following example is applicable to this scenario as well.
See xref:clustering/setup/analytics-cluster.adoc[] for more information on analytical clusters.
====
