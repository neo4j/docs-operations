...
Each database has it own independent topology, organized into primaries and secondaries (for read scaling).
...
image::operational-view_new.svg[title="Cluster architecture",width=800,role="middle"]
