...
| `raftCommandsPerSecond` label:deprecated[Deprecated in 5.4]  | number   | yes    | `124`                       | An estimate of the average Raft state machine throughput over a sampling window configurable via `clustering.status_throughput_window` setting.
