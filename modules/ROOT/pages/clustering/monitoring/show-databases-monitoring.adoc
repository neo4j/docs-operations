...
.Showing databases in standalone Neo4j
====
...
[[show-databases-monitoring-listing-cluster]]
.Showing databases in a cluster
====
...
.Showing statuses for database _foo_
====
...
== Showing more details about databases
...
| `lastCommittedTxn`         | Integer      | The latest <<commit, committed>> transaction number on this database server.
