...
**Example:** `causal_clustering.raft_advertised_address=192.168.33.20:7000` listens for for cluster communication in the network interface bound to `192.168.33.20` on port `7000`.
