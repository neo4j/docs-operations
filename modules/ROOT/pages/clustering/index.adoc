...
* label:new[Introduced in 2026.03] label:preview[Preview feature] xref:clustering/replicating-databases-across-clusters.adoc[Cross-cluster database replication] -- How to replicate a database across clusters.
