...
** xref:clustering/setup/discovery.adoc[Cluster server discovery] -- How servers in a cluster discover each other using discovery v1.
** xref:clustering/setup/discovery_v2.adoc[Cluster server discovery v2] -- How servers in a cluster discover each other using discovery v2.
