...
* For instructions on how you can upgrade your Neo4j Causal Cluster, see link:{neo4j-docs-base-uri}/upgrade-migration-guide/current/upgrade/upgrade-4.1/causal-cluster/[Upgrade and Migration Guide -> Upgrade a Causal Cluster].
