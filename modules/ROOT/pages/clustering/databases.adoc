...
This limitation is due to a non-existing Raft replication when only a single server is running, i.e. the server is running in _standalone_ or _single mode_.
