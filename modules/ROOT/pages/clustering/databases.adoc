...
Moreover, it is possible to automatically transition form a topology with a single primary host to multiple primary hosts. During such a transition the database will be unavailable for a short period of time.
