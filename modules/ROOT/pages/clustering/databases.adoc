...
The S3 is supported by default, but the other providers require configuration of xref:reference/configuration-settings.adoc#config_dbms.databases.seed_from_uri_providers[`dbms.databases.seed_from_uri_providers`].
