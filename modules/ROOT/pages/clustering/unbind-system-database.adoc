...
However, since all servers in the <<database-management-system, DBMS>> need to be shut down to run the command, downtime will occur for all databases inside of the DBMS.
====
