:description: This section details a few selected internals of a Neo4j cluster.
[role=enterprise-edition]
[[clustering-internals]]
= Internals of clustering
:description: This section details a few selected internals of a Neo4j cluster. Understanding the internals is not vital but can be helpful in diagnosing and resolving operational issues. 
...
[[clustering-multi-database-and-the-reconciler]]
...
In a cluster deployment of Neo4j, Cypher queries may be directed to a cluster member that is unable to run the given query.
