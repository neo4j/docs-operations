...
For more information on the `CREATE DATABASE` syntax and options, see link:/docs/cypher-manual/{neo4j-version}/administration/databases/#administration-databases-create-database[Cypher Manual -> Creating databases].
