...
For more information on the `CREATE DATABASE` syntax and options, see link:{neo4j-docs-base-uri}/cypher-manual/4.4/databases#administration-databases-create-database[Cypher Manual -> Creating databases].
