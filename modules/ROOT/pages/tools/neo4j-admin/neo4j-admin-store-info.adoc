...
[NOTE]
====
For more information on how to migrate a single database, see link:{upgrade-current-uri}/migration/migrate-to-4.any/online-backup-copy-database/[Upgrade and Migration Guide -> Tutorial: Back up and copy a database in a standalone instance].
====
