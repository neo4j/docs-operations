...
You must upgrade your Neo4j to 5.26 LTS minimum.
After that, you can upgrade Neo4j to any release of 2025-2026 cycle.
See the link:{neo4j-docs-base-uri}/operations-manual/current/[latest calendar version of Neo4j server]. +
...
[CAUTION]
====
The `neo4j-admin push-to-cloud` command is not compatible with instances encrypted with link:{neo4j-docs-base-uri}/aura/platform/security/[Customer Managed Keys].
...
[CAUTION]
====
This command does not currently support link:https://neo4j.com/docs/aura/platform/security/secure-connections/#_vpc_isolation[private linking].
Please link:https://support.neo4j.com/[raise a support ticket] if you have public traffic disabled and need to use this command.
====
