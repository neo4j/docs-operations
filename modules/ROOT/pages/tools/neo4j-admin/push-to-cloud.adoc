...
The following table shows the compatibility between the version of the database or dump that you want to upload and the version of the Neo4j Aura instance.

[options="header" cols="50%, 50%"]
|===
| Database or dump version 
| Aura version
