...
|Password of the target database to push this database to. Prompt will ask for a password if not provided. Default:  The value of the `ENV_NEO4J_PASSWORD` environment variable."
|
...
|--to-user=<username>
|Username of the target database to push this database to. Prompt will ask for a username if not provided. Default:  The value of the `ENV_NEO4J_USERNAME` environment variable.
|
