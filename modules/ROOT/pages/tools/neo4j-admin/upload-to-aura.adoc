...
The option of using a `.backup` file with the `neo4j-admin database upload` command was introduced in 5.22.
...
The name is used to select a file which is expected to be named <database>.dump or <database>.backup.
|===
