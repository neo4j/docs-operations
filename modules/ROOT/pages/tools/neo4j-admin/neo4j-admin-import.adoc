...
[source,shell]
----
bin/neo4j-admin database import full --nodes azb://myStorageAccount/myContainer/data/nodes.csv --relationships myStorageAccount/myContainer/data/relationships.csv newdb
----
======
=====
