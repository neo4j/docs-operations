...
== Incremental import (offline)

The `neo4j-admin database import incremental` command imports a large amount of data from CSV files into an existing offline database.
