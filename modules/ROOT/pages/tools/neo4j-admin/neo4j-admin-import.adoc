...
Arrays are not affected by the `--normalize-types` flag. For example, if you want a byte array to be stored as a Cypher long array you must explicitly declare the property as `long[]`.
