...
When using both a multi-value option and a positional parameter, the multi-value option behaves as greedy and pulls in the next positional parameter via its convertor.
