...
* label:new[Introduced in 5.25] label:enterprise[Enterprise Edition] `backup` - backup-specific tasks.
...
| `unbind-system-db`
| label:new[Introduced in 5.0] label:enterprise[Enterprise Edition] +
...
.1+| label:new[Introduced in 5.25] label:enterprise[Enterprise Edition] +
`backup`

|`inspect`
| label:new[Introduced in 5.25] +
