...
.2+.>|*Store format*              4+^|*Migration paths*
                                   |Block label:enterprise[EE] |Aligned label:community[CE]  |High_limit label:enterprise[EE] label:deprecated[Deprecated in 5.23] |Standard label:community[CE] label:deprecated[Deprecated in 5.23]

|Block label:enterprise[EE]      |                            ^|{check-mark}                 |{check-mark} Not recommended |{check-mark} Not recommended

|Aligned label:community[CE]     ^|{check-mark}                |                             |{check-mark} Not recommended | 

|High_limit label:enterprise[EE] label:deprecated[Deprecated in 5.23]  ^|{check-mark} |  |  |  

|Standard label:community[CE] label:deprecated[Deprecated in 5.23]    ^|{check-mark} ^|{check-mark} |{check-mark} Not recommended | 
|===
