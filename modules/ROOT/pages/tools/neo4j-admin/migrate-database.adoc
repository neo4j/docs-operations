...
|`block` footnote:1[The `block` format is the default format for Enterprise Edition starting from 5.22.]     |  |{check-mark} Not recommended  |{check-mark} Not recommended |{check-mark} Not recommended

|`aligned` footnote:2[The `aligned` format is the default format for Community Edition and for Enterprise Edition prior 5.22.]     ^|{check-mark}                |                             |{check-mark} Not recommended | 
