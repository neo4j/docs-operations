...
It can also be downloaded from {download-center-uri}/#cyphershell[Neo4j Download Center] and installed separately.
...
. Download Cypher Shell from {download-center-uri}/#cyphershell[Neo4j Download Center].
