...
It can also be downloaded from link:https://neo4j.com/download-center/#cyphershell[Neo4j Download Center] and installed separately.
...
. Download Cypher Shell from link:https://neo4j.com/download-center/#cyphershell[Neo4j Download Center].
