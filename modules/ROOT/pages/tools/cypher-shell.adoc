...
It can also be downloaded from link:https://neo4j.com/deployment-center/?cypher-shell[Neo4j Deployment Center] and installed separately.
...
<1> label:new[Introduced in Neo4j 5.11]
