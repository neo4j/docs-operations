...
For deprecations in Cypher language, see link:{neo4j-docs-base-uri}/cypher-manual/5/deprecations-additions-removals-compatibility/[Cypher manual -> Deprecations, additions, and compatibility].
