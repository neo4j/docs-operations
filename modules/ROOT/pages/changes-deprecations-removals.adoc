:description: Page lists breaking changes in Neo4j 2025.01 and deprecations in Neo4j 2025 and 2026 series. Here you can find changes made to procedures, configurations settings, metrics, and `neo4j-admin` commands.
...
= Changes, deprecations, and removals in Neo4j 2025.x and 2026.x
