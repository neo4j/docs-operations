...
+
. Two configuration settings related to the discovery service v2 were renamed.
...
== Deprecations in Neo4j 2025.xx

This section lists all of the features that have been deprecated in Neo4j server of 2025.x series.
