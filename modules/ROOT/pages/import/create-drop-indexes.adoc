...
:page-role: enterprise-edition new-2025.02
...
For more information on graph types, see link:{neo4j-docs-base-uri}/cypher-manual/current/schema/graph-types/[CypherManual -> Graph types].
