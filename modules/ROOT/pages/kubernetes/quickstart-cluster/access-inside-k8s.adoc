...
This will create a K8s Service with a xref:kubernetes/accessing-neo4j/standalone.adoc#cluster-access-inside-k8s-dns[DNS entry] that includes all the Neo4j servers.
