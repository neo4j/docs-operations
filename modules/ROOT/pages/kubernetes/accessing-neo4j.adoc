...
* <<bolt-protocol, Neo4j Bolt>> for Neo4j administration via Cypher commands.
...
----
kubectl run -it --rm --image neo4j:{neo4j-helm-chart-version} cypher-shell -- cypher-shell -a bolt://my-release-admin.default.svc.cluster.local
----
