...
You can perform a backup of a Neo4j database as well as multiple databases (from Neo4j 5.10.0 and later) to any cloud provider (AWS, GCP, and Azure) bucket using the _neo4j/neo4j-admin_ Helm chart.
