...
----
helm upgrade <release-name> neo4j/neo4j --version={neo4j-helm-chart-version} --reuse-values --set neo4j.offlineMaintenanceModeEnabled=true
----
...
[source, shell, subs="attributes"]
----
helm upgrade <release-name> neo4j/neo4j-standalone --version={neo4j-helm-chart-version} --reuse-values --set neo4j.offlineMaintenanceModeEnabled=false
----
