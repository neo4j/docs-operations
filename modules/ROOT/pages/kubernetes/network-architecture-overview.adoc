...
In a Neo4j cluster, the driver can use [client-side routing](https://neo4j.com/docs/operations-manual/current/clustering/setup/routing/#clustering-client-side-routing) to discover and connect directly to individual cluster members.
