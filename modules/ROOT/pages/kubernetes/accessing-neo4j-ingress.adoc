...
The Helm chart is called _neo4j/helm-charts-reverse-proxy_ and is available on the Neo4j Helm repository from version 4.4.25.
...
reverseProxy:
  image: "neo4j/helm-charts-reverse-proxy:4.4.25"
