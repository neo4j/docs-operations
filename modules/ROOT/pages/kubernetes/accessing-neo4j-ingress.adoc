...
For more information about exposing TCP/UDP services, see link:https://kubernetes.github.io/ingress-nginx/exposing-tcp-udp-services/[Ingress-Nginx Controller official documentation -> Exposing TCP and UDP services].
