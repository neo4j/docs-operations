...
kind: Secret
metadata:
  creationTimestamp: "2023-01-04T11:19:44Z"
  managedFields:
  - apiVersion: v1
    fieldsType: FieldsV1
    fieldsV1:
    ...
    manager: kubectl
    operation: Update
    time: "2023-01-04T11:19:44Z"
  name: neo4j-tls
  namespace: neo4j
  resourceVersion: "173840"
  uid: 181d3fcb-d817-4f98-8b3b-9f5b3cee5fad
...
----
. Connect to one of the server and verify that the _/certificates/cluster_ directory contains the certificates:
+
[source, shell]
----
...
----
total 12
4 drwxr-xr-x 2 root root 4096 Jan  4 11:23 bolt
4 drwxr-xr-x 3 root root 4096 Jan  4 11:23 cluster
4 drwxr-xr-x 3 root root 4096 Jan  4 11:23 https
----
+
[source, shell]
----
...
----
total 8
0 drwxrwsrwt 3 root neo4j  100 Jan  4 11:22 trusted
4 -rw-r--r-- 1 root neo4j 1704 Jan  4 11:22 private.key
4 -rw-r--r-- 1 root neo4j 1159 Jan  4 11:22 public.crt
----
+
[source, shell]
----
...
----
total 0
0 lrwxrwxrwx 1 root neo4j 17 Jan  4 11:22 public.crt -> ..data/public.crt
----
. Exit the pod:
+
[source, shell]
...
my-cluster-lb-neo4j   LoadBalancer   10.0.152.137   40.88.209.157   7474:30691/TCP,7473:31627/TCP,7687:31056/TCP   8m30s
----
. Connect to the Neo4j cluster using one of the following options:
+
* Neo4j Browser:
.. Open a web browser and type _https://lb-EXTERNAL_IP:7473_ (in this example, https://40.88.209.157:7473/browser/).
