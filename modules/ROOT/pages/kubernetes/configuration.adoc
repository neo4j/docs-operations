...
.. Convert the _public.crt_ and _private.key_ files into `base64`` format using the following commands:
+
[source, shell]
----
...
----
.. Create a _secret.yaml_ file by copying the output from the conversion commands of _public.crt_ and _private.key_:
+
[source, yaml]
----
apiVersion: v1
