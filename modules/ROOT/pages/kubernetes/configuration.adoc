...
:description: This section describes how to configure a Neo4j Helm deployment to run in a Kubernetes cluster. 
...
For more information on how to configure your identity provider and what settings you should define, see xref:tutorial/tutorial-sso-configuration/index.adoc[Neo4j Single Sign-On (SSO) configuration].
