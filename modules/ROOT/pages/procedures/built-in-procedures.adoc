...
It also lists current <<deprecated-procedures, deprecated procedures>> and the <<removed-procedures, procedures removed in Neo4j 5>>, along with their replacements.
