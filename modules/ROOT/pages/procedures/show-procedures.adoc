...
| isDeprecated
| label:new[Introduced in 5.9] Whether the procedure is deprecated.
| BOOLEAN
|

| deprecatedBy
| label:new[Introduced in 5.21] The replacement procedure to use in case of deprecation; otherwise `null`.
| STRING
|
