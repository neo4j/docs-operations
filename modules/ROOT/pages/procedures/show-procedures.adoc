...
For more information about `DBMS EXECUTE` privilege administration, see the xref:authentication-authorization/dbms-administration/dbms-execute-privileges.adoc[The `DBMS EXECUTE` privileges].
