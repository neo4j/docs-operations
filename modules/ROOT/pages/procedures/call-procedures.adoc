...
Additionally, starting with Neo4j 2026.06, they can include the `WHERE` clause.
...
A subset of the composable commands are allowed on the `system` database and can be combined with procedure calls there.
