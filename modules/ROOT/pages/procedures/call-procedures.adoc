...
== Procedure calls against the `system` database

When run against the `system` database, the queries are more restricted, as most Cypher clauses are not allowed there.
