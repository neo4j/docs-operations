...
Calling a `VOID` procedure in the middle of a larger query simply passes on each input record (i.e., it acts like link:{neo4j-docs-base-uri}/cypher-manual/clauses/with/[`WITH *`] in terms of the record stream).
