...
| List procedures executable by a specified user
|
...
// Question: do we want examples of for each relevant page, or is one section in the proposed main SHOW page in the Cypher Manual sufficient?

`SHOW PROCEDURES` can be combined other Cypher commands to form a single query.
