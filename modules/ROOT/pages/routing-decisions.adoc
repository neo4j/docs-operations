...
. link:{neo4j-docs-base-uri}/cypher-manual/4.4/clauses/use[Cypher `USE` clause]
** Note that link:{neo4j-docs-base-uri}/cypher-manual/4.4/databases[administration commands]  implicitly have `USE system`.
