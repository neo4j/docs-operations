...
* If the target database is a xref::database-administration/composite-databases/manage-composite-databases.adoc[Composite database], then the context type is _Composite_. +
+
[NOTE]
====
...
====
+
* If the target database is a xref:database-administration/aliases/manage-aliases.adoc[Remote Alias], then the context type is _External_.
